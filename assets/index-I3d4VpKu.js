...
` + e4.stack;
    ...
    var vt2 = /* @__PURE__ */ new Set(), yt2 = {};
    function H2(e3, t3) {
      U2(e3, t3), U2(e3 + `Capture`, t3);
    }
    function U2(e3, t3) {
      for (yt2[e3] = t3, e3 = 0; e3 < t3.length; e3++) vt2.add(t3[e3]);
    }
    ...
    function Dc(e3, t3, n3) {
      ...
      switch (t3.lanes = 0, t3.tag) {
        ...
        case 3:
          ...
          return t3;
        case 26:
          return lc(e3, t3), e3 === null ? (n3 = Af(t3.type, null, t3.pendingProps, null)) ? t3.memoizedState = n3 : J || (n3 = t3.type, e3 = t3.pendingProps, r3 = Vd(ce2.current).createElement(n3), r3[at2] = t3, r3[ot2] = e3, Fd(r3, n3, e3), _t2(r3), t3.stateNode = r3) : t3.memoizedState = Af(t3.type, e3.memoizedProps, t3.pendingProps, e3.memoizedState), null;
        case 27:
          ...
          if (fl(t3, e3), hl(e3), r3 & 512 && (Zc || n3 === null || Hc(n3, n3.return)), r3 & 4) {
            ...
            if (r3 = e3.memoizedState, n3 === null) if (r3 === null) if (e3.stateNode === null) {
              a: {
                ...
                b: switch (r3) {
                  case `title`:
                    o3 = a3.getElementsByTagName(`title`)[0], (!o3 || o3[ft2] || o3[at2] || o3.namespaceURI === `http://www.w3.org/2000/svg` || o3.hasAttribute(`itemprop`)) && (o3 = a3.createElement(r3), a3.head.insertBefore(o3, a3.querySelector(`head > title`))), Fd(o3, r3, n3), o3[at2] = e3, _t2(o3), r3 = o3;
                    break a;
                  case `link`:
    ...
    function Sd(e3) {
      if (!e3[xd]) {
        e3[xd] = true, vt2.forEach(function(t4) {
        ...
        if (!(t3 & 7)) {
          a: {
            ...
            if ((l4 || c4) && (c4 = i4.window === i4 ? i4 : (c4 = i4.ownerDocument) ? c4.defaultView || c4.parentWindow : window, l4 ? (u2 = n3.relatedTarget || n3.toElement, l4 = r4, u2 = u2 ? mt2(u2) : null, u2 !== null && (f2 = o2(u2), d3 = u2.tag, u2 !== f2 || d3 !== 5 && d3 !== 27 && d3 !== 6) && (u2 = null)) : (l4 = null, u2 = r4), l4 !== u2)) {
              if (d3 = bn2, g3 = `onMouseLeave`, p3 = `onMouseEnter`, m2 = `mouse`, (e3 === `pointerout` || e3 === `pointerover`) && (d3 = Mn, g3 = `onPointerLeave`, p3 = `onPointerEnter`, m2 = `pointer`), f2 = l4 == null ? c4 : V2(l4), h3 = u2 == null ? c4 : V2(u2), c4 = new d3(g3, m2 + `leave`, l4, n3, i4), c4.target = f2, c4.relatedTarget = h3, g3 = null, mt2(i4) === r4 && (d3 = new d3(p3, m2 + `enter`, u2, n3, i4), d3.target = h3, d3.relatedTarget = f2, g3 = d3), f2 = g3, l4 && u2) b: {
          ...
          a: {
            if (c4 = r4 ? V2(r4) : window, l4 = c4.nodeName && c4.nodeName.toLowerCase(), l4 === `select` || l4 === `input` && c4.type === `file`) var v3 = nr;
...
`).replace(Ad, ``);
  ...
  async function N(e2, t2, n2, r2) {
    ...
    if (a2 > A) throw Error(`Too many points (${a2}). This client supports up to ${A} (start + ${A - 2} stops + end).`);
    let o2 = i2.map((e3) => `${e3.lng},${e3.lat}`).join(`;`), s2 = Math.max(1, Math.floor(O / a2)), c2 = Math.ceil(a2 / s2), l2 = [];
    for (let e3 = 0; e3 < c2; e3++) {
      let t3 = e3 * s2, n3 = Math.min(a2, t3 + s2), i3 = Array.from({
        length: n3 - t3
      }, (e4, n4) => t3 + n4).join(`;`), u2 = await M(`${E}/${o2}?annotations=duration` + (c2 > 1 ? `&sources=${i3}` : ``));
      ...
      r2?.(e3 + 1, c2), e3 < c2 - 1 && await j(k);
    }
    return l2.map((e3) => e3.map((e4) => e4 == null ? D : Math.round(e4)));
  }
  async function P(e2) {
  ...
  async function lt(e2, t2) {
    ...
    try {
      ...
      let s2 = Xe();
      s2.firstSolutionStrategy = B.PATH_CHEAPEST_ARC;
  ...
  async function pt(e2, t2, n2, r2, i2) {
    let a2 = [
      e2,
      ...t2,
      n2
    ...
    let o2 = await N(e2, t2, n2, (e3, t3) => {
      i2?.(t3 > 1 ? `Fetching cost matrix\u2026 ${e3}/${t3}` : `Fetching cost matrix\u2026`);
    });
    i2?.(`Optimizing route\u2026`);
    let s2 = await lt(o2, r2), c2 = s2.map((e3) => a2[e3]), l2 = 0;
    ...
    try {
      ...
      let e3 = 0;
      for (let t3 = 0; t3 < c2.length - 1; t3++) e3 += ft(c2[t3], c2[t3 + 1]);
      return {
        orderedWaypoints: c2,
        geometry: {
          type: `LineString`,
  ...
  var mt = w()(te((e2, t2) => ({
    ...
    removeWaypoint: (t3) => e2((e3) => ({
      waypoints: e3.waypoints.filter((e4, n2) => n2 !== t3)
    })),
    clearWaypoints: () => e2({
      waypoints: []
    }),
    ...
    calculateRoute: async () => {
      let { startLocation: n2, endLocation: r2, waypoints: i2, targetK: a2 } = t2();
      if (!(!n2 || !r2)) {
        e2({
          isCalculating: true,
          routeError: null,
        ...
        try {
          e2({
            optimizedRoute: await pt(n2, i2, r2, a2 ?? i2.length, (t3) => e2({
              calcStatus: t3
            })),
            solverReady: true
          });
  ...
  function gt() {
    let e2 = mt((e3) => !!(e3.startLocation || e3.endLocation || e3.waypoints.length > 0 || e3.optimizedRoute)), t2 = mt((e3) => e3.resetAll), n2 = mt((e3) => e3.solverWarning);
  ...
  function H({ field: e2, label: t2, accentClass: n2 = `bg-blue-600` }) {
    let r2 = mt((t3) => e2 === `start` ? t3.startLocation : t3.endLocation), i2 = mt((t3) => e2 === `start` ? t3.setStart : t3.setEnd), [a2, o2] = (0, _.useState)(``), [s2, c2] = (0, _.useState)(``), [l2, u2] = (0, _.useState)(null);
    function d2(e3) {
      e3.preventDefault();
      let t3 = vt(a2, s2);
      if (!t3) {
...
`,
    ...
    return new Promise((t2) => {
      ...
      n2.onload = () => {
        ...
        try {
          ...
          i2.forEach((t3, n3) => {
            let i3 = t3 && typeof t3 == `object` ? vt(t3.lat, t3.lng) : null;
  ...
  function wt(e2) {
    ...
    return t2.endsWith(`.json`) ? W(e2) : t2.endsWith(`.csv`) ? Ct(e2) : e2.type.includes(`json`) ? W(e2) : Ct(e2);
  }
  function Tt() {
    let e2 = mt((e3) => e3.addWaypoints), t2 = (0, _.useRef)(null), [n2, r2] = (0, _.useState)(null), [i2, a2] = (0, _.useState)([]), [o2, s2] = (0, _.useState)(false), [c2, l2] = (0, _.useState)(false);
  ...
  function Et() {
    let e2 = mt((e3) => e3.waypoints), t2 = mt((e3) => e3.removeWaypoint);
    return e2.length === 0 ? (0, V.jsx)(`p`, {
      ...
      children: e2.map((e3, n2) => (0, V.jsxs)(`li`, {
  ...
  function Dt() {
    let e2 = mt((e3) => e3.waypoints.length), t2 = mt((e3) => e3.clearWaypoints);
  ...
  function Ot() {
    let e2 = mt((e3) => e3.targetK), t2 = mt((e3) => e3.waypoints.length), n2 = mt((e3) => e3.setTargetK), r2 = e2 !== null && t2 > 0 && e2 > t2;
    function i2(e3) {
      if (e3 === ``) {
        n2(null);
        return;
  ...
  function kt() {
    let e2 = mt((e3) => e3.isCalculating), t2 = mt((e3) => e3.calcStatus), n2 = mt((e3) => e3.routeError), r2 = mt((e3) => e3.solverReady), i2 = mt((e3) => !!(e3.startLocation && e3.endLocation));
    return (0, V.jsxs)(`section`, {
      className: `space-y-2`,
      children: [
        (0, V.jsx)(`button`, {
          onClick: mt((e3) => e3.calculateRoute),
          disabled: !(i2 && !e2),
  ...
  var Nt = `https://www.google.com/maps`;
  function Pt(e2) {
    return `${e2.lat},${e2.lng}`;
  }
  function Ft(e2) {
    return `${Nt}/search/?${new URLSearchParams({
      api: `1`,
      query: Pt(e2)
    }).toString()}`;
  }
  function It(e2) {
    ...
    for (let n2 = 0; n2 < e2.length - 1; n2 += 10) {
      ...
      o2.length > 0 && s2.set(`waypoints`, o2.map(Pt).join(`|`)), t2.push({
        url: `${Nt}/dir/?${s2.toString()}`,
        fromIndex: n2,
  ...
  function Rt({ route: e2 }) {
    let t2 = e2.orderedWaypoints, n2 = It(t2), r2 = `block rounded-md bg-emerald-600 px-3 py-2 text-center text-sm font-semibold text-white transition-colors hover:bg-emerald-700`;
    return (0, V.jsxs)(`div`, {
      className: `space-y-3`,
      children: [
        (0, V.jsx)(`div`, {
  ...
  function zt() {
    let e2 = mt((e3) => e3.optimizedRoute), t2 = mt((e3) => e3.waypoints.length);
  ...
  function G(e2) {
    function t2(t3, n2) {
      ...
      let { children: a2 } = t3;
      return a2 == null ? null : _.createElement(Ut, {
        value: i2
      }, a2);
    }
  ...
  function Kt(e2) {
    function t2(t3, n2) {
      ...
      return o2 ? (0, Gt.createPortal)(t3.children, o2) : null;
    }
    return (0, _.forwardRef)(t2);
  }
  function K(e2) {
  ...
  function Yt(e2, t2) {
    return function(n2, r2) {
      let i2 = Wt(), a2 = e2(Jt(n2, i2), i2);
      return Bt(i2.map, n2.attribution), qt(a2.current, n2.eventHandlers), t2(a2.current, i2, n2, r2), a2;
    };
  }
  var Xt = o(((e2, t2) => {
    (function(n2, r2) {
      ...
      function At2(e4, t4, n3) {
        ...
        e4.style[V2] = (B2.ie3d ? `translate(` + r3.x + `px,` + r3.y + `px)` : `translate3d(` + r3.x + `px,` + r3.y + `px,0)`) + (n3 ? ` scale(` + n3 + `)` : ``);
      }
      function jt2(e4, t4) {
      ...
      var cn2 = {
        ...
        initialize: function(e4, t4) {
          t4 = p2(this, t4), this._handlers = [], this._layers = {}, this._zoomBoundLayers = {}, this._sizeChanged = true, this._initContainer(e4), this._initLayout(), this._onResize = i2(this._onResize, this), this._initEvents(), t4.maxBounds && this.setMaxBounds(t4.maxBounds), t4.zoom !== void 0 && (this._zoom = this._limitZoom(t4.zoom)), t4.center && t4.zoom !== void 0 && this.setView(R2(t4.center), t4.zoom, {
            reset: true
          }), this.callInitHooks(), this._zoomAnimated = gt2 && B2.any3d && !B2.mobileOpera && this.options.zoomAnimation, this._zoomAnimated && (this._createAnimProxy(), G2(this._proxy, _t2, this._catchTransitionEnd, this)), this._addLayers(this.options.layers);
        },
        ...
        _createAnimProxy: function() {
          ...
          this._panes.mapPane.appendChild(e4), this.on(`zoomanim`, function(e5) {
            var t4 = V2, n3 = this._proxy.style[t4];
  ...
  function en(e2) {
    return function(t2) {
      let n2 = Wt(), r2 = e2(Jt(t2, n2), n2);
      return Bt(n2.map, t2.attribution), qt(r2.current, t2.eventHandlers), $t(r2.current, n2), r2;
    };
  }
  function tn(e2, t2) {
    let n2 = (0, _.useRef)(void 0);
  ...
  function nn(e2) {
    return function(t2) {
      let n2 = Wt(), r2 = e2(Jt(t2, n2), n2);
      return qt(r2.current, t2.eventHandlers), $t(r2.current, n2), tn(r2.current, t2), r2;
    };
  }
  function rn(e2, t2) {
    return G(en(Qt(e2, t2)));
  }
  function an(e2, t2) {
    return Kt(Yt(Qt(e2), t2));
  }
  function on(e2, t2) {
    return G(nn(Qt(e2, t2)));
  }
  function sn(e2, t2) {
    return K(en(Qt(e2, t2)));
  }
  ...
  var q = c(Xt(), 1);
  function un({ bounds: e2, boundsOptions: t2, center: n2, children: r2, className: i2, id: a2, placeholder: o2, style: s2, whenReady: c2, zoom: l2, ...u2 }, d2) {
    let [f2] = (0, _.useState)({
      className: i2,
      id: a2,
      style: s2
    ...
    let g2 = (0, _.useCallback)((r3) => {
      if (r3 !== null && !h2.current) {
        let i3 = new q.Map(r3, u2);
        h2.current = i3, n2 != null && l2 != null ? i3.setView(n2, l2) : e2 != null && i3.fitBounds(e2, t2), c2 != null && i3.whenReady(c2), m2(Vt(i3));
      }
    }, []);
    (0, _.useEffect)(() => () => {
      p2?.map.remove();
  ...
  var dn = (0, _.forwardRef)(un), fn = rn(function({ position: e2, ...t2 }, n2) {
    let r2 = new q.Marker(e2, t2);
    return Zt(r2, Ht(n2, {
      overlayContainer: r2
    }));
  }, function(e2, t2, n2) {
  ...
  }), pn = on(function({ positions: e2, ...t2 }, n2) {
    let r2 = new q.Polyline(e2, t2);
    return Zt(r2, Ht(n2, {
      overlayContainer: r2
    }));
  }, function(e2, t2, n2) {
    t2.positions !== n2.positions && e2.setLatLngs(t2.positions);
  }), mn = an(function(e2, t2) {
    return Zt(new q.Popup(e2, t2.overlayContainer), t2);
  ...
  }), hn = sn(function({ url: e2, ...t2 }, n2) {
    return Zt(new q.TileLayer(e2, Jt(t2, n2)), n2);
  }, function(e2, t2, n2) {
    cn(e2, t2, n2);
    let { url: r2 } = t2;
    r2 != null && r2 !== n2.url && e2.setUrl(r2);
  }), gn = (e2) => Symbol.iterator in e2, _n = (e2) => `entries` in e2, vn = (e2, t2) => {
  ...
  function bn(e2, t2) {
    return Object.is(e2, t2) ? true : typeof e2 != `object` || !e2 || typeof t2 != `object` || !t2 || Object.getPrototypeOf(e2) !== Object.getPrototypeOf(t2) ? false : gn(e2) && gn(t2) ? _n(e2) && _n(t2) ? vn(e2, t2) : yn(e2, t2) : vn({
  ...
  function xn(e2) {
    ...
    return (n2) => {
      let r2 = e2(n2);
      return bn(t2.current, r2) ? t2.current : t2.current = r2;
    };
  }
  function Sn(e2, t2) {
    return q.default.divIcon({
      className: ``,
      html: `<div style="
  ...
  var Cn = Sn(`#059669`, `S`), wn = Sn(`#e11d48`, `E`);
  function Tn({ points: e2, fitKey: t2 }) {
    let n2 = ln();
    return (0, _.useEffect)(() => {
      ...
      let t3 = q.default.latLngBounds(e2.map((e3) => [
        e3.lat,
        e3.lng
      ]));
      n2.fitBounds(t3, {
  ...
  function En() {
    let { startLocation: e2, endLocation: t2, waypoints: n2, optimizedRoute: r2 } = mt(xn((e3) => ({
      startLocation: e3.startLocation,
      endLocation: e3.endLocation,
      waypoints: e3.waypoints,
      optimizedRoute: e3.optimizedRoute
    }))), i2 = (0, _.useMemo)(() => r2 ? r2.orderedWaypoints.slice(1, -1).map((e3, t3) => ({
      point: e3,
      number: t3 + 2,
      optimized: true
    })) : n2.map((e3, t3) => ({
    ...
    return (0, V.jsxs)(dn, {
      ...
      children: [
        ...
        i2.map((e3, t3) => (0, V.jsx)(fn, {
          position: [
            e3.point.lat,
            e3.point.lng
          ],
          icon: Sn(`#2563eb`, String(e3.number)),
          children: (0, V.jsxs)(mn, {
            children: [
              (0, V.jsx)(`strong`, {
