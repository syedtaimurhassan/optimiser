...
` + e4.stack;
    ...
    function kt2(e3) {
      if (!e3._valueTracker) {
        var t3 = U2(e3) ? `checked` : `value`;
        e3._valueTracker = W2(e3, t3, `` + e3[t3]);
      }
    }
    function At2(e3) {
      if (!e3) return false;
      ...
      return e3 && (r3 = U2(e3) ? e3.checked ? `true` : `false` : e3.value), e3 = r3, e3 === n3 ? false : (t3.setValue(e3), true);
    }
    function jt2(e3) {
    ...
    function zt2(e3, t3, n3, r3) {
      ...
      n3 = Ot2(t3), e3.defaultValue = n3, r3 = e3.textContent, r3 === n3 && r3 !== `` && r3 !== null && (e3.value = r3), kt2(e3);
    }
    function Bt2(e3, t3) {
      if (t3) {
    ...
    function Cd(e3, t3, n3, r3) {
      ...
      n3 = i3.bind(null, t3, n3, e3), i3 = void 0, !nn || t3 !== `touchstart` && t3 !== `touchmove` && t3 !== `wheel` || (i3 = true), r3 ? i3 === void 0 ? e3.addEventListener(t3, n3, true) : e3.addEventListener(t3, n3, {
        capture: true,
        passive: i3
    ...
    function wd(e3, t3, n3, r3, i3) {
      ...
      $t2(function() {
        ...
        if (!(t3 & 7)) {
          ...
          x3 && (Vn && n3.locale !== `ko` && (Kn || x3 !== `onCompositionStart` ? x3 === `onCompositionEnd` && Kn && (b3 = cn()) : (an = i4, on = `value` in an ? an.value : an.textContent, Kn = true)), y3 = Ed(r4, x3), 0 < y3.length && (x3 = new Tn(x3, e3, null, n3, i4), s4.push({
            event: x3,
            listeners: y3
...
`,
  ...
  var ve = o(((e2, t2) => {
    (function(n2, r2) {
      ...
      function U2(e4, t4) {
        `opacity` in e4.style ? e4.style.opacity = t4 : `filter` in e4.style && W2(e4, t4);
      }
      function W2(e4, t4) {
      ...
      var an = z2.linux && z2.chrome ? window.devicePixelRatio : z2.mac ? window.devicePixelRatio * 3 : window.devicePixelRatio > 0 ? 2 * window.devicePixelRatio : 1;
      function on(e4) {
        return z2.edge ? e4.wheelDeltaY / 2 : e4.deltaY && e4.deltaMode === 0 ? -e4.deltaY / an : e4.deltaY && e4.deltaMode === 1 ? -e4.deltaY * 20 : e4.deltaY && e4.deltaMode === 2 ? -e4.deltaY * 60 : e4.deltaX || e4.deltaZ ? 0 : e4.wheelDelta ? (e4.wheelDeltaY || e4.wheelDelta) / 2 : e4.detail && Math.abs(e4.detail) < 32765 ? -e4.detail * 20 : e4.detail ? e4.detail / -32765 * 60 : 0;
      }
      function sn(e4, t4) {
      ...
      var pn = dn.extend({
        ...
        _createButton: function(e4, t4, n3, r3, i3) {
          var a3 = B2(`a`, n3, r3);
          return a3.innerHTML = e4, a3.href = `#`, a3.title = t4, a3.setAttribute(`role`, `button`), a3.setAttribute(`aria-label`, t4), $t2(a3), G2(a3, `click`, tn), G2(a3, `click`, i3, this), G2(a3, `click`, this._refocusOnMap, this), a3;
        },
      ...
      var xn = {
        ...
        _onDown: function(e4) {
          if (this._enabled && (this._moved = false, !Tt2(this._element, `leaflet-zoom-anim`))) {
            ...
            if (!(Cn._dragging || e4.shiftKey || e4.which !== 1 && e4.button !== 1 && !e4.touches) && (Cn._dragging = this, this._preventOutline && Vt2(this._element), Lt2(), Nt2(), !this._moving)) {
              this.fire(`down`);
      ...
      var rr = tr.extend({
        ...
        _updateOpacity: function() {
          ...
          this._icon && U2(this._icon, e4), this._shadow && U2(this._shadow, e4);
        },
      ...
      var Dr = Er, Or = Xn.extend({
        ...
        _updateOpacity: function() {
          U2(this._image, this.options.opacity);
        },
      ...
      var Pr = Xn.extend({
        ...
        onAdd: function(e4) {
          this._zoomAnimated = e4._zoomAnimated, this._container || this._initLayout(), e4._fadeAnimated && U2(this._container, 0), clearTimeout(this._removeTimeout), this.getPane().appendChild(this._container), this.update(), e4._fadeAnimated && U2(this._container, 1), this.bringToFront(), this.options.interactive && (H2(this._container, `leaflet-interactive`), this.addInteractiveTarget(this._container));
        },
        onRemove: function(e4) {
          e4._fadeAnimated ? (U2(this._container, 0), this._removeTimeout = setTimeout(i2(V2, void 0, this._container), 200)) : V2(this._container), this.options.interactive && (Et2(this._container, `leaflet-interactive`), this.removeInteractiveTarget(this._container));
        },
        getLatLng: function() {
          return this._latlng;
        },
      ...
      var Lr = Pr.extend({
        ...
        setOpacity: function(e4) {
          this.options.opacity = e4, this._container && U2(this._container, e4);
        },
        _animateZoom: function(e4) {
      ...
      var Vr = Xn.extend({
        ...
        _updateOpacity: function() {
          if (this._map && !z2.ielt9) {
            U2(this._container, this.options.opacity);
            ...
            for (var r3 in this._tiles) {
              ...
              if (!(!i3.current || !i3.loaded)) {
                ...
                U2(i3.el, a3), a3 < 1 ? t4 = true : (i3.active ? n3 = true : this._onOpaqueTile(i3), i3.active = true);
              }
            }
        ...
        _initTile: function(e4) {
          ...
          e4.style.width = t4.x + `px`, e4.style.height = t4.y + `px`, e4.onselectstart = l2, e4.onmousemove = l2, z2.ielt9 && this.options.opacity < 1 && U2(e4, this.options.opacity);
        },
        ...
        _tileReady: function(e4, t4, n3) {
          ...
          n3 = this._tiles[r3], n3 && (n3.loaded = +/* @__PURE__ */ new Date(), this._map._fadeAnimated ? (U2(n3.el, 0), T2(this._fadeFrame), this._fadeFrame = ee2(this._updateOpacity, this)) : (n3.active = true, this._pruneTiles()), t4 || (H2(n3.el, `leaflet-tile-loaded`), this.fire(`tileload`, {
            tile: n3.el,
            coords: e4
      ...
      $r.create = Qr, $r.pointsToPath = fe2, gr.geometryToLayer = _r, gr.coordsToLatLng = yr, gr.coordsToLatLngs = br, gr.latLngToCoords = xr, gr.latLngsToCoords = Sr, gr.getFeature = Cr, gr.asFeature = wr, q.mergeOptions({
        boxZoom: true
      });
      var ri = bn.extend({
        initialize: function(e4) {
      ...
      q.addInitHook(`addHandler`, `boxZoom`, ri), q.mergeOptions({
      ...
      q.addInitHook(`addHandler`, `doubleClickZoom`, ii), q.mergeOptions({
        dragging: true,
        inertia: true,
      ...
      q.addInitHook(`addHandler`, `dragging`, ai), q.mergeOptions({
        keyboard: true,
        keyboardPanDelta: 80
      });
      var oi = bn.extend({
      ...
      q.addInitHook(`addHandler`, `keyboard`, oi), q.mergeOptions({
      ...
      q.addInitHook(`addHandler`, `tapHold`, li), q.mergeOptions({
        touchZoom: z2.touch,
      ...
      q.addInitHook(`addHandler`, `touchZoom`, ui), q.BoxZoom = ri, q.DoubleClickZoom = ii, q.Drag = ai, q.Keyboard = oi, q.ScrollWheelZoom = si, q.TapHold = li, q.TouchZoom = ui, e3.Bounds = M2, e3.Browser = z2, e3.CRS = re2, e3.Canvas = Jr, e3.Circle = ur, e3.CircleMarker = cr, e3.Class = E2, e3.Control = dn, e3.DivIcon = zr, e3.DivOverlay = Pr, e3.DomEvent = cn, e3.DomUtil = Gt2, e3.Draggable = Cn, e3.Evented = O2, e3.FeatureGroup = $n, e3.GeoJSON = gr, e3.GridLayer = Vr, e3.Handler = bn, e3.Icon = tr, e3.ImageOverlay = Or, e3.LatLng = I2, e3.LatLngBounds = P2, e3.Layer = Xn, e3.LayerGroup = Zn, e3.LineUtil = Un, e3.Map = q, e3.Marker = ar, e3.Mixin = xn, e3.Path = sr, e3.Point = k2, e3.PolyUtil = Dn, e3.Polygon = mr, e3.Polyline = fr, e3.Popup = Fr, e3.PosAnimation = ln, e3.Projection = Kn, e3.Rectangle = ti, e3.Renderer = qr, e3.SVG = $r, e3.SVGOverlay = Mr, e3.TileLayer = Ur, e3.Tooltip = Lr, e3.Transformation = se2, e3.Util = te2, e3.VideoOverlay = Ar, e3.bind = i2, e3.bounds = N2, e3.canvas = Yr, e3.circle = dr, e3.circleMarker = lr, e3.control = fn, e3.divIcon = Br, e3.extend = n2, e3.featureGroup = er, e3.geoJSON = Er, e3.geoJson = Dr, e3.gridLayer = Hr, e3.icon = nr, e3.imageOverlay = kr, e3.latLng = R2, e3.latLngBounds = F2, e3.layerGroup = Qn, e3.map = un, e3.marker = or, e3.point = j2, e3.polygon = hr, e3.polyline = pr, e3.popup = Ir, e3.rectangle = ni, e3.setOptions = p2, e3.stamp = o2, e3.svg = ei, e3.svgOverlay = Nr, e3.tileLayer = Wr, e3.tooltip = Rr, e3.transformation = ce2, e3.version = t3, e3.videoOverlay = jr;
      var di = window.L;
  ...
  var Ue = `https://router.project-osrm.org/table/v1/driving`, We = `https://router.project-osrm.org/route/v1/driving`, Ge = 9999999;
  async function Ke(e2, t2, n2) {
    let r2 = [
      e2,
      ...t2,
      n2
    ];
    if (r2.length < 2) throw Error(`At least a start and an end location are required.`);
    let i2 = `${Ue}/${r2.map((e3) => `${e3.lng},${e3.lat}`).join(`;`)}?annotations=duration`, a2;
    try {
      a2 = await fetch(i2);
    } catch (e3) {
      throw Error(`Could not reach the OSRM service: ${e3.message}`);
    }
    if (!a2.ok) throw Error(`OSRM table request failed: ${a2.status} ${a2.statusText}`);
    let o2 = await a2.json();
    if (o2.code !== `Ok` || !o2.durations) throw Error(`OSRM could not build a duration matrix (${o2.message ?? o2.code}).`);
    return o2.durations.map((e3) => e3.map((e4) => e4 == null ? Ge : Math.round(e4)));
  }
  async function qe(e2) {
    if (e2.length < 2) throw Error(`A route needs at least two points.`);
    let t2 = `${We}/${e2.map((e3) => `${e3.lng},${e3.lat}`).join(`;`)}?overview=full&geometries=geojson`, n2;
    try {
      n2 = await fetch(t2);
    } catch (e3) {
      throw Error(`Could not reach the OSRM service: ${e3.message}`);
    }
    if (!n2.ok) throw Error(`OSRM route request failed: ${n2.status} ${n2.statusText}`);
    let r2 = await n2.json();
    if (r2.code !== `Ok` || !r2.routes?.length) throw Error(`OSRM could not build a route (${r2.message ?? r2.code}).`);
    let i2 = r2.routes[0];
    return {
      geometry: i2.geometry,
      distanceMeters: i2.distance,
      durationSeconds: i2.duration
    };
  }
  function Je() {
  ...
  function Xe(e2 = Ye()) {
    return e2 === `browser-main` || e2 === `bun` || e2 === `deno` ? `asyncify` : Je() ? `jspi` : `asyncify`;
  }
  function z(e2) {
    let t2 = {}, n2 = null;
    function r2() {
      return n2 || (n2 = Xe(), e2.logFlavorSelection && console.log(n2 === `jspi` ? `JSPI is supported. Using JSPI runtime.` : `Using Asyncify runtime.`), n2);
    }
  ...
  var Ze = `modulepreload`, Qe = function(e2) {
    return `/optimiser/` + e2;
  }, $e = {}, et = function(e2, t2, n2) {
    ...
    if (t2 && t2.length > 0) {
      ...
      r2 = o2(t2.map((t3) => {
        if (t3 = Qe(t3, n2), t3 = s2(t3), t3 in $e) return;
        $e[t3] = true;
        ...
        if (i4.rel = r3 ? `stylesheet` : Ze, r3 || (i4.as = `script`), i4.crossOrigin = ``, i4.href = t3, a2 && i4.setAttribute(`nonce`, a2), document.head.appendChild(i4), r3) return new Promise((e4, n3) => {
  ...
  function it(e2) {
    for (let t2 of Object.values(tt)) for (let n2 of Object.values(t2)) {
      if (e2 === rt(n2.jsUrl)) return n2.jsUrl;
      if (e2 === rt(n2.wasmUrl)) return n2.wasmUrl;
    }
    return e2;
  }
  var at = z({
    ...
    async resolveAsset(e2, t2) {
      let n2 = tt[e2][t2], r2 = new Uint8Array(await (await fetch(n2.wasmUrl)).arrayBuffer());
      return {
        jsUrl: n2.jsUrl,
        locateFile: it,
        wasmBinary: r2,
  ...
  at.terminateLoadedRuntimeThreads, at.loadRuntime, at.loadRuntimeAsyncify;
  var ot = at.loadRoutingRuntime;
  at.loadRoutingRuntimeAsyncify, at.loadMPSolverRuntime, at.loadMPSolverRuntimeAsyncify, at.loadMathOptRuntime, at.loadMathOptRuntimeAsyncify, at.loadPdlpRuntime, at.loadPdlpRuntimeAsyncify, at.loadGraphRuntime, at.loadGraphRuntimeAsyncify, at.loadSetCoverRuntime, at.loadSetCoverRuntimeAsyncify;
  var st = typeof window < `u` && typeof document < `u`, ct = `Deno` in globalThis, lt = `Bun` in globalThis, ut = typeof process < `u` && typeof process.versions?.node == `string` && !ct && !lt, dt = (st || ct || lt) && typeof Worker < `u` || ut, ft = null, pt = null, mt = st && dt, ht = 1, gt = /* @__PURE__ */ new Map();
  function _t() {
    return mt && dt;
  }
  function vt() {
  ...
  function yt(e2) {
    if (mt = !!e2, mt && !dt) throw mt = false, Error(`Worker bridge requested but no worker is available in this environment.`);
    mt || xt(`OR-Tools worker bridge disabled.`);
  }
  function bt() {
    return ht++;
  }
  function xt(e2) {
    if (!ft) return;
    ft.terminate(), ft = null, pt = null;
    let t2 = Error(e2 ?? `OR-Tools worker terminated.`);
    for (let e3 of gt.values()) e3.reject(t2);
    gt.clear();
  }
  async function B() {
  ...
  async function V() {
    if (!dt) throw Error(`Worker bridge is not available.`);
    if (ft) return ft;
    let e2 = await B();
    return e2.unref?.(), ft = e2, pt = new Promise((t2, n2) => {
      let r2 = (e3) => {
        if (e3.type === `ready`) {
          t2();
          return;
        ...
        if (e3.type === `solveCallback`) {
          if (r3?.onEvent) try {
            ...
            gt.delete(e3.id), r3.reject(t3);
          }
          return;
        }
        if (e3.type === `error`) {
          let t3 = Error(e3.error);
          r3 ? (r3.reject(t3), gt.delete(e3.id)) : n2(t3);
          return;
        }
        r3 && (gt.delete(e3.id), r3.resolve(e3));
      }, i2 = (e3) => {
  ...
  async function St() {
    if (!dt) throw Error(`Worker bridge is not available.`);
    if (await V(), !pt) throw Error(`Worker ready state unavailable.`);
    await pt;
  }
  async function Ct(e2, t2) {
    if (!dt) throw Error(`Worker bridge is not available.`);
    let n2 = await V();
    return await St(), new Promise((r2, i2) => {
      gt.set(e2.id, {
        resolve: (e3) => r2(e3),
        reject: i2,
        onEvent: t2
  ...
  var wt = Object.defineProperty, Tt = (e2, t2, n2) => t2 in e2 ? wt(e2, t2, {
    enumerable: true,
    configurable: true,
    writable: true,
    value: n2
  }) : e2[t2] = n2, H = (e2, t2, n2) => Tt(e2, typeof t2 == `symbol` ? t2 : t2 + ``, n2), Et = 1, Dt = null, Ot = null;
  function U(e2) {
  ...
  function Wt(e2) {
    return typeof e2 == `object` && !!e2 && e2.type === `routingVehicleEquality` && Ht(e2.left) && Ht(e2.right);
  }
  function Gt(e2) {
    return typeof e2 == `object` && !!e2 && e2.type === `routingCumulLessOrEqual` && Ut(e2.left) && Ut(e2.right);
  }
  var G = class {
    constructor(e2, t2, n2, r2) {
      if (H(this, `ready`, Promise.resolve()), H(this, `module`, null), H(this, `handle`, 0), H(this, `indexToNodeMap`, []), H(this, `nodeToIndexMap`, /* @__PURE__ */ new Map()), H(this, `startIndices`, []), H(this, `endIndices`, []), H(this, `numLocations`), H(this, `numVehicles`), H(this, `starts`), H(this, `ends`), this.numLocations = e2, this.numVehicles = t2, Array.isArray(n2)) {
      ...
      if (this.createSyntheticIndexMapping(), Ft() && (this.module = Lt(), this.handle = Array.isArray(n2) ? this.createStartsEndsManager(this.starts, this.ends) : this.module._routing_create_index_manager(this.numLocations, this.numVehicles, n2), this.handle === 0)) throw Error(`RoutingIndexManager: failed to create native manager.`);
    }
    get depot() {
    ...
    indexToNodeSync(e2) {
      ...
      return U(this.module._routing_manager_index_to_node(this.nativeHandle, W(e2)));
    }
    IndexToNode(e2) {
    ...
    nodeToIndexSync(e2) {
      return this.module ? U(this.module._routing_manager_node_to_index(this.nativeHandle, e2)) : this.nodeToIndexMap.get(e2) ?? -1;
    }
    NodeToIndex(e2) {
    ...
    GetStartIndex(e2) {
      return this.module ? U(this.module._routing_manager_start_index(this.nativeHandle, e2)) : this.startIndices[e2];
    }
    GetEndIndex(e2) {
      return this.module ? U(this.module._routing_manager_end_index(this.nativeHandle, e2)) : this.endIndices[e2];
    }
    delete() {
    ...
    createStartsEndsManager(e2, t2) {
      ...
      try {
        return this.module.HEAPU8.set(kt(e2), r2), this.module.HEAPU8.set(kt(t2), i2), this.module._routing_create_index_manager_starts_ends(this.numLocations, this.numVehicles, r2, i2);
      } finally {
    ...
    constructor(e2, t2) {
      H(this, `routing`, e2), H(this, `name`, t2), H(this, `softSpanUpperBounds`, /* @__PURE__ */ new Map()), H(this, `quadraticCostSoftSpanUpperBounds`, /* @__PURE__ */ new Map());
    }
    CumulVar(e2) {
      return {
    ...
    SetSoftSpanUpperBoundForVehicle(e2, t2) {
      if (!this.routing.hasNativeModule()) {
        this.softSpanUpperBounds.set(t2, new Vt(e2.bound, e2.cost));
        return;
      }
    ...
    GetSoftSpanUpperBoundForVehicle(e2) {
      return this.routing.hasNativeModule() ? this.routing.withCString(this.name, (t2) => new Vt(U(this.routing.moduleRef._routing_dimension_get_soft_span_upper_bound_bound(this.routing.nativeHandle, t2, e2)), U(this.routing.moduleRef._routing_dimension_get_soft_span_upper_bound_cost(this.routing.nativeHandle, t2, e2)))) : this.softSpanUpperBounds.get(e2) ?? new Vt(0, 0);
    }
    ...
    SetQuadraticCostSoftSpanUpperBoundForVehicle(e2, t2) {
      if (!this.routing.hasNativeModule()) {
        this.quadraticCostSoftSpanUpperBounds.set(t2, new Vt(e2.bound, e2.cost));
        return;
      }
      this.routing.withCString(this.name, (n2) => {
    ...
    GetQuadraticCostSoftSpanUpperBoundForVehicle(e2) {
      return this.routing.hasNativeModule() ? this.routing.withCString(this.name, (t2) => new Vt(U(this.routing.moduleRef._routing_dimension_get_quadratic_cost_soft_span_upper_bound_bound(this.routing.nativeHandle, t2, e2)), U(this.routing.moduleRef._routing_dimension_get_quadratic_cost_soft_span_upper_bound_cost(this.routing.nativeHandle, t2, e2)))) : this.quadraticCostSoftSpanUpperBounds.get(e2) ?? new Vt(0, 0);
    }
  }, K = class {
    constructor(e2, t2 = null) {
      H(this, `routing`, e2), H(this, `workerResult`, t2);
    }
    ObjectiveValue() {
    ...
    constructor(e2, t2) {
      if (H(this, `manager`, e2), H(this, `ready`, Promise.resolve()), H(this, `module`, null), H(this, `handle`, 0), H(this, `callbackIds`, /* @__PURE__ */ new Set()), H(this, `transitCallbacks`, /* @__PURE__ */ new Map()), H(this, `arcCostEvaluatorIndex`, null), H(this, `lastWorkerResult`, null), H(this, `evaluatorCallbacks`, /* @__PURE__ */ new Map()), H(this, `nextWorkerEvaluatorIndex`, 1), H(this, `operations`, []), H(this, `dimensionNames`, /* @__PURE__ */ new Set()), H(this, `atSolutionCallbacks`, []), H(this, `lastObjectiveValue`, 0), H(this, `lastWorkerStatus`, null), H(this, `parameters`), this.parameters = t2, Ft() && (this.module = Lt(), this.handle = this.module._routing_create_model(this.manager.nativeHandle), this.handle === 0)) throw Error(`RoutingModel: failed to create native model.`);
    }
    ...
    async solveWithWorkerRequest(e2) {
      ...
      let n2 = new K(this, t2.result);
      return this.lastObjectiveValue = n2.ObjectiveValue(), this.runAtSolutionCallbacks(), n2;
    }
    async SolveWithParameters(e2 = Bt()) {
      if (_t()) return this.solveWithWorkerRequest(e2);
    ...
    async Solve() {
      return this.SolveWithParameters(Bt());
    }
    solveWithParametersSync(e2 = Bt()) {
    ...
    Start(e2) {
      return this.lastWorkerResult?.starts[e2] === void 0 ? this.module ? U(this.module._routing_start(this.handle, e2)) : this.manager.GetStartIndex(e2) : this.lastWorkerResult.starts[e2];
    }
    End(e2) {
      return this.lastWorkerResult?.ends[e2] === void 0 ? this.module ? U(this.module._routing_end(this.handle, e2)) : this.manager.GetEndIndex(e2) : this.lastWorkerResult.ends[e2];
    }
    IsEnd(e2) {
    ...
    AddDimensionWithVehicleCapacity(e2, t2, n2, r2, i2) {
      ...
      let a2 = At(n2), o2 = new Uint8Array(a2.buffer, a2.byteOffset, a2.byteLength), s2 = this.module._malloc(o2.byteLength);
    ...
    AddDimensionWithVehicleTransits(e2, t2, n2, r2, i2) {
      ...
      let a2 = kt(e2), o2 = this.module._malloc(a2.byteLength);
    ...
    AddVectorDimension(e2, t2, n2, r2) {
      ...
      let i2 = At(e2), a2 = new Uint8Array(i2.buffer, i2.byteOffset, i2.byteLength), o2 = this.module._malloc(a2.byteLength);
      this.module.HEAPU8.set(a2, o2);
      try {
    ...
    AddMatrixDimension(e2, t2, n2, r2) {
      ...
      let i2 = At(e2.flat()), a2 = new Uint8Array(i2.buffer, i2.byteOffset, i2.byteLength), o2 = this.module._malloc(a2.byteLength);
      this.module.HEAPU8.set(a2, o2);
      try {
    ...
    AddDisjunction(e2, t2) {
      ...
      let n2 = At(e2), r2 = new Uint8Array(n2.buffer, n2.byteOffset, n2.byteLength), i2 = this.module._malloc(r2.byteLength);
    ...
    GetNumberOfDecisionsInFirstSolution(e2) {
      ...
      let t2 = U(this.module._routing_get_number_of_decisions_in_first_solution(this.handle, e2.firstSolutionStrategy ?? 0, e2.solution_limit ?? 0));
      return t2 === 0 && e2.firstSolutionStrategy === 10 ? this.manager.GetNumberOfIndices() : t2;
    }
    GetNumberOfRejectsInFirstSolution(e2) {
      return this.module ? U(this.module._routing_get_number_of_rejects_in_first_solution(this.handle, e2.firstSolutionStrategy ?? 0, e2.solution_limit ?? 0)) : 0;
    }
    ...
    ReadAssignmentFromRoutes(e2, t2) {
      if (!this.module) {
        ...
        return this.lastWorkerResult = n3, this.lastWorkerStatus = 1, this.lastObjectiveValue = n3.objectiveValue, new K(this, n3);
      }
      let n2 = e2.map((e3) => e3.length), r2 = At(e2.flat()), i2 = new Uint8Array(r2.buffer, r2.byteOffset, r2.byteLength), a2 = kt(n2), o2 = this.module._malloc(i2.byteLength), s2 = this.module._malloc(a2.byteLength);
    ...
    GetArcCostForVehicle(e2, t2, n2) {
      ...
      return U(this.module._routing_get_arc_cost_for_vehicle(this.handle, W(e2), W(t2), n2));
    }
    assignmentObjectiveValue() {
      return this.module ? U(this.module._routing_assignment_objective_value(this.handle)) : this.lastObjectiveValue;
    }
    nextValue(e2) {
      return this.lastWorkerResult ? this.lastWorkerResult.nextValues[e2] : this.module ? U(this.module._routing_next_value(this.handle, W(e2))) : e2;
    }
    dimensionCumulValue(e2, t2) {
      return this.module ? this.withCString(e2, (e3) => U(this.moduleRef._routing_assignment_dimension_cumul_value(this.handle, e3, W(t2)))) : this.lastWorkerResult?.dimensionCumulValues[e2]?.[t2] ?? 0;
    }
    delete() {
      for (let e2 of this.callbackIds) this.module?.__routingTransitCallbacks?.delete(e2);
      this.transitCallbacks.clear(), this.callbackIds.clear(), this.handle !== 0 && (this.module && Pt() && this.module._routing_delete_model(this.handle), this.handle = 0);
    }
    ...
    withCString(e2, t2) {
      if (!this.module) throw Error(`RoutingModel: native routing module is not available in worker bridge mode.`);
      let n2 = jt(e2), r2 = this.module._malloc(n2.byteLength);
  ...
  async function Yt(e2, t2) {
    ...
    try {
      ...
      let s2 = Bt();
      s2.firstSolutionStrategy = zt.PATH_CHEAPEST_ARC;
  ...
  function Qt(e2, t2) {
    let n2 = Zt(t2.lat - e2.lat), r2 = Zt(t2.lng - e2.lng), i2 = Math.sin(n2 / 2) ** 2 + Math.cos(Zt(e2.lat)) * Math.cos(Zt(t2.lat)) * Math.sin(r2 / 2) ** 2;
    return 2 * Xt * Math.asin(Math.sqrt(i2));
  }
  async function $t(e2, t2, n2, r2) {
    let i2 = [
      e2,
      ...t2,
      n2
    ];
    if (i2.length > 100) throw Error(`The public OSRM server allows at most 100 points per request; you have ${i2.length} (start + ${t2.length} stops + end). Reduce the number of candidate stops.`);
    let a2 = await Ke(e2, t2, n2), o2 = await Yt(a2, r2), s2 = o2.map((e3) => i2[e3]), c2 = 0;
    for (let e3 = 0; e3 < o2.length - 1; e3++) c2 += a2[o2[e3]][o2[e3 + 1]];
    try {
      let e3 = await qe(s2);
      return {
        orderedWaypoints: s2,
      ...
      let e3 = 0;
      for (let t3 = 0; t3 < s2.length - 1; t3++) e3 += Qt(s2[t3], s2[t3 + 1]);
      return {
        orderedWaypoints: s2,
        geometry: {
          type: `LineString`,
          coordinates: s2.map((e4) => [
            e4.lng,
            e4.lat
          ])
        },
  ...
  function en() {
    let [e2, t2] = (0, _.useState)(null), [n2, r2] = (0, _.useState)(null), [i2, a2] = (0, _.useState)([]), [o2, s2] = (0, _.useState)(null), [c2, l2] = (0, _.useState)(null), [u2, d2] = (0, _.useState)(null), [f2, p2] = (0, _.useState)(false), m2 = (e3) => a2((t3) => [
      ...t3,
      ...e3
    ]), h2 = (e3) => a2((t3) => t3.filter((t4, n3) => n3 !== e3)), g2 = () => a2([]), v2 = !!(e2 && n2) && !f2;
    async function y2() {
      if (!(!e2 || !n2)) {
        p2(true), d2(null);
        try {
          let t3 = o2 ?? i2.length, r3 = await $t(e2, i2, n2, t3);
          l2(r3);
        } catch (e3) {
            ...
            (0, C.jsxs)(`section`, {
              ...
              children: [
                (0, C.jsx)(`button`, {
                  ...
                  children: f2 ? `Calculating\u2026` : `Calculate Route`
                }),
                !e2 || !n2 ? (0, C.jsx)(`p`, {
                  className: `text-xs text-slate-400`,
                ...
                c2 && (0, C.jsxs)(C.Fragment, {
                  children: [
                    (0, C.jsxs)(`p`, {
                      className: `text-xs text-slate-500`,
                      children: [
                        `Visiting `,
                        c2.orderedWaypoints.length - 2,
                        ` of`,
                        ` `,
                        i2.length,
                        ` candidate stop`,
