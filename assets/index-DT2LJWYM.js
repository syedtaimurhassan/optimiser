...
` + e4.stack;
    ...
    var xe2 = Object.prototype.hasOwnProperty, Se2 = t2.unstable_scheduleCallback, Ce2 = t2.unstable_cancelCallback, we2 = t2.unstable_shouldYield, Te2 = t2.unstable_requestPaint, Ee2 = t2.unstable_now, De2 = t2.unstable_getCurrentPriorityLevel, Oe2 = t2.unstable_ImmediatePriority, ke2 = t2.unstable_UserBlockingPriority, Ae2 = t2.unstable_NormalPriority, je2 = t2.unstable_LowPriority, Me2 = t2.unstable_IdlePriority, Ne2 = t2.log, Pe2 = t2.unstable_setDisableYieldValue, Fe2 = null, Ie2 = null;
    function Le2(e3) {
      if (typeof Ne2 == `function` && Pe2(e3), Ie2 && typeof Ie2.setStrictMode == `function`) try {
        Ie2.setStrictMode(Fe2, e3);
      } catch {
      }
    }
    ...
    function Tt2(e3) {
      return xe2.call(wt2, e3) ? true : xe2.call(Ct2, e3) ? false : St2.test(e3) ? wt2[e3] = true : (Ct2[e3] = true, false);
    }
    ...
    function At2(e3) {
      if (!e3._valueTracker) {
        var t3 = kt2(e3) ? `checked` : `value`;
        e3._valueTracker = U2(e3, t3, `` + e3[t3]);
      }
    }
    function jt2(e3) {
      if (!e3) return false;
      ...
      return e3 && (r3 = kt2(e3) ? e3.checked ? `true` : `false` : e3.value), e3 = r3, e3 === n3 ? false : (t3.setValue(e3), true);
    }
    function Mt2(e3) {
    ...
    var Nt2 = /[\n"\\]/g;
    function W2(e3) {
      return e3.replace(Nt2, function(e4) {
        return `\\` + e4.charCodeAt(0).toString(16) + ` `;
      });
    }
    function Pt2(e3, t3, n3, r3, i3, a3, o3, s3) {
      e3.name = ``, o3 != null && typeof o3 != `function` && typeof o3 != `symbol` && typeof o3 != `boolean` ? e3.type = o3 : e3.removeAttribute(`type`), t3 == null ? o3 !== `submit` && o3 !== `reset` || e3.removeAttribute(`value`) : o3 === `number` ? (t3 === 0 && e3.value === `` || e3.value != t3) && (e3.value = `` + Ot2(t3)) : e3.value !== `` + Ot2(t3) && (e3.value = `` + Ot2(t3)), t3 == null ? n3 == null ? r3 != null && e3.removeAttribute(`value`) : It2(e3, o3, Ot2(n3)) : It2(e3, o3, Ot2(t3)), i3 == null && a3 != null && (e3.defaultChecked = !!a3), i3 != null && (e3.checked = i3 && typeof i3 != `function` && typeof i3 != `symbol`), s3 != null && typeof s3 != `function` && typeof s3 != `symbol` && typeof s3 != `boolean` ? e3.name = `` + Ot2(s3) : e3.removeAttribute(`name`);
    }
    function Ft2(e3, t3, n3, r3, i3, a3, o3, s3) {
      if (a3 != null && typeof a3 != `function` && typeof a3 != `symbol` && typeof a3 != `boolean` && (e3.type = a3), t3 != null || n3 != null) {
        ...
        n3 = n3 == null ? `` : `` + Ot2(n3), t3 = t3 == null ? n3 : `` + Ot2(t3), s3 || t3 === e3.value || (e3.value = t3), e3.defaultValue = t3;
      }
      r3 ??= i3, r3 = typeof r3 != `function` && typeof r3 != `symbol` && !!r3, e3.checked = s3 ? e3.checked : !!r3, e3.defaultChecked = !!r3, o3 != null && typeof o3 != `function` && typeof o3 != `symbol` && typeof o3 != `boolean` && (e3.name = o3), At2(e3);
    }
    function It2(e3, t3, n3) {
      t3 === `number` && Mt2(e3.ownerDocument) === e3 || e3.defaultValue === `` + n3 || (e3.defaultValue = `` + n3);
    }
    function Lt2(e3, t3, n3, r3) {
      if (e3 = e3.options, t3) {
        ...
        for (n3 = `` + Ot2(n3), t3 = null, i3 = 0; i3 < e3.length; i3++) {
          if (e3[i3].value === n3) {
    ...
    function Rt2(e3, t3, n3) {
      if (t3 != null && (t3 = `` + Ot2(t3), t3 !== e3.value && (e3.value = t3), n3 == null)) {
        e3.defaultValue !== t3 && (e3.defaultValue = t3);
        return;
      }
      e3.defaultValue = n3 == null ? `` : `` + Ot2(n3);
    }
    function zt2(e3, t3, n3, r3) {
      ...
      n3 = Ot2(t3), e3.defaultValue = n3, r3 = e3.textContent, r3 === n3 && r3 !== `` && r3 !== null && (e3.value = r3), At2(e3);
    }
    function Bt2(e3, t3) {
      if (t3) {
        ...
        a: switch (e3 = t3.stateNode, t3.type) {
          case `input`:
            if (Pt2(e3, n3.value, n3.defaultValue, n3.defaultValue, n3.checked, n3.defaultChecked, n3.type, n3.name), t3 = n3.name, n3.type === `radio` && t3 != null) {
              ...
              for (n3 = n3.querySelectorAll(`input[name="` + W2(`` + t3) + `"][type="radio"]`), t3 = 0; t3 < n3.length; t3++) {
                var r3 = n3[t3];
              ...
              for (t3 = 0; t3 < n3.length; t3++) r3 = n3[t3], r3.form === e3.form && jt2(r3);
            }
            break a;
          case `textarea`:
    ...
    var jn = dn2(h2({}, mn, {
      key: function(e3) {
        ...
        return e3.type === `keypress` ? (e3 = ln2(e3), e3 === 13 ? `Enter` : String.fromCharCode(e3)) : e3.type === `keydown` || e3.type === `keyup` ? Dn[e3.keyCode] || `Unidentified` : ``;
      },
      code: 0,
      location: 0,
      ctrlKey: 0,
    ...
    function Zn(e3, t3, n3, r3) {
      Yt2 ? Xt2 ? Xt2.push(r3) : Xt2 = [
        r3
      ] : Yt2 = r3, t3 = Ed(t3, `onChange`), 0 < t3.length && (n3 = new pn(`onChange`, `change`, null, n3, r3), e3.push({
        event: n3,
        listeners: t3
      }));
    }
    ...
    function yr(e3) {
      ...
      for (var t3 = Mt2(e3.document); t3 instanceof e3.HTMLIFrameElement; ) {
        try {
    ...
    function Er(e3, t3, n3) {
      ...
      Tr || Sr == null || Sr !== Mt2(r3) || (r3 = Sr, `selectionStart` in r3 && br(r3) ? r3 = {
      ...
      }), wr && hr(wr, r3) || (wr = r3, r3 = Ed(Cr, `onSelect`), 0 < r3.length && (t3 = new pn(`onSelect`, `select`, null, t3, n3), e3.push({
        event: t3,
        listeners: r3
      }), t3.target = Sr)));
    }
    ...
    function Dc(e3, t3, n3) {
      ...
      switch (t3.lanes = 0, t3.tag) {
        ...
        case 3:
          ...
          return t3;
        case 26:
          return lc(e3, t3), e3 === null ? (n3 = Af(t3.type, null, t3.pendingProps, null)) ? t3.memoizedState = n3 : J || (n3 = t3.type, e3 = t3.pendingProps, r3 = Vd(ce2.current).createElement(n3), r3[ot2] = t3, r3[st2] = e3, Fd(r3, n3, e3), yt2(r3), t3.stateNode = r3) : t3.memoizedState = Af(t3.type, e3.memoizedProps, t3.pendingProps, e3.memoizedState), null;
        case 27:
    ...
    function sl(e3, t3, n3) {
      if (Ie2 && typeof Ie2.onCommitFiberUnmount == `function`) try {
        Ie2.onCommitFiberUnmount(Fe2, n3);
      } catch {
      }
      switch (n3.tag) {
        case 26:
    ...
    function ku(e3, t3) {
      ...
      X |= 2;
      var r3 = wu(), a3 = Tu();
      Il !== e3 || Q !== t3 ? (tu = null, eu = Ee2() + 500, xu(e3, t3)) : Bl = qe2(e3, t3);
      a: do
        try {
          if (Ll !== 0 && Z !== null) {
            t3 = Z;
    ...
    function Iu(e3, t3, n3, r3, a3, o3, s3, c3, l3) {
      ...
      if (t3 !== null) {
        ...
        if (o3 = t3.lanes | t3.childLanes, o3 |= Gr, Ze2(e3, n3, o3, s3, c3, l3), e3 === Il && (Z = Il = null, Q = 0), au = t3, iu = e3, ou = n3, su = o3, cu = a3, lu = r3, t3.subtreeFlags & 10256 || t3.flags & 10256 ? (e3.callbackNode = null, e3.callbackPriority = 0, Xu(Ae2, function() {
          return Hu(), null;
    ...
    function zu() {
      if (ru === 4 || ru === 3) {
        ...
        if (i3 === 0 && (nu = null), nt2(n3), t3 = t3.stateNode, Ie2 && typeof Ie2.onCommitFiberRoot == `function`) try {
          Ie2.onCommitFiberRoot(Fe2, t3, void 0, (t3.current.flags & 128) == 128);
        } catch {
        }
        if (r3 !== null) {
    ...
    function Hu() {
      ...
      try {
        ...
        if (X |= 4, jl(o3.current), Cl(o3, o3.current, s3, n3), X = c3, id(0, false), Ie2 && typeof Ie2.onPostCommitFiberRoot == `function`) try {
          Ie2.onPostCommitFiberRoot(Fe2, o3);
        } catch {
        }
        return true;
      } finally {
    ...
    function sd(e3, t3) {
      ...
      if (t3 = Il, n3 = Q, n3 = Ke2(e3, e3 === t3 ? n3 : 0, e3.cancelPendingCommit !== null || e3.timeoutHandle !== -1), r3 = e3.callbackNode, n3 === 0 || e3 === t3 && (Ll === 2 || Ll === 9) || e3.cancelPendingCommit !== null) return r3 !== null && r3 !== null && Ce2(r3), e3.callbackNode = null, e3.callbackPriority = 0;
      if (!(n3 & 3) || qe2(e3, n3)) {
        if (t3 = n3 & -n3, t3 === e3.callbackPriority) return t3;
        switch (r3 !== null && Ce2(r3), nt2(n3)) {
          case 2:
          case 8:
            n3 = ke2;
            break;
    ...
    function cd(e3, t3) {
      ...
      var r3 = Q;
      return r3 = Ke2(e3, e3 === Il ? r3 : 0, e3.cancelPendingCommit !== null || e3.timeoutHandle !== -1), r3 === 0 ? null : (hu(e3, r3, t3), sd(e3, Ee2()), e3.callbackNode != null && e3.callbackNode === n3 ? cd.bind(null, e3) : null);
    }
    function ld(e3, t3) {
      if (Vu()) return null;
      hu(e3, t3, true);
        ...
        if (!(t3 & 7)) {
          a: {
            ...
            if ((l4 || c4) && (c4 = i4.window === i4 ? i4 : (c4 = i4.ownerDocument) ? c4.defaultView || c4.parentWindow : window, l4 ? (u2 = n3.relatedTarget || n3.toElement, l4 = r4, u2 = u2 ? ht2(u2) : null, u2 !== null && (f2 = o2(u2), d3 = u2.tag, u2 !== f2 || d3 !== 5 && d3 !== 27 && d3 !== 6) && (u2 = null)) : (l4 = null, u2 = r4), l4 !== u2)) {
              if (d3 = bn, g3 = `onMouseLeave`, p3 = `onMouseEnter`, m2 = `mouse`, (e3 === `pointerout` || e3 === `pointerover`) && (d3 = Mn, g3 = `onPointerLeave`, p3 = `onPointerEnter`, m2 = `pointer`), f2 = l4 == null ? c4 : _t2(l4), h3 = u2 == null ? c4 : _t2(u2), c4 = new d3(g3, m2 + `leave`, l4, n3, i4), c4.target = f2, c4.relatedTarget = h3, g3 = null, ht2(i4) === r4 && (d3 = new d3(p3, m2 + `enter`, u2, n3, i4), d3.target = h3, d3.relatedTarget = f2, g3 = d3), f2 = g3, l4 && u2) b: {
          ...
          x3 && (Vn && n3.locale !== `ko` && (Kn || x3 !== `onCompositionStart` ? x3 === `onCompositionEnd` && Kn && (b3 = cn2()) : (an2 = i4, on2 = `value` in an2 ? an2.value : an2.textContent, Kn = true)), y3 = Ed(r4, x3), 0 < y3.length && (x3 = new Tn(x3, e3, null, n3, i4), s4.push({
            event: x3,
            listeners: y3
          }), b3 ? x3.data = b3 : (b3 = Gn(n3), b3 !== null && (x3.data = b3)))), (b3 = Bn ? qn(e3, n3) : Jn(e3, n3)) && (x3 = Ed(r4, `onBeforeInput`), 0 < x3.length && (y3 = new Tn(`onBeforeInput`, `beforeinput`, null, n3, i4), s4.push({
            event: y3,
            listeners: x3
...
`).replace(Ad, ``);
    ...
    function Nd(e3, t3, n3, r3, a3, o3) {
      switch (n3) {
        ...
        case `popover`:
          ...
          break;
        case `xlinkActuate`:
          Dt2(e3, `http://www.w3.org/1999/xlink`, `xlink:actuate`, r3);
          break;
        case `xlinkArcrole`:
          Dt2(e3, `http://www.w3.org/1999/xlink`, `xlink:arcrole`, r3);
          break;
        case `xlinkRole`:
          Dt2(e3, `http://www.w3.org/1999/xlink`, `xlink:role`, r3);
          break;
        case `xlinkShow`:
          Dt2(e3, `http://www.w3.org/1999/xlink`, `xlink:show`, r3);
          break;
        case `xlinkTitle`:
          Dt2(e3, `http://www.w3.org/1999/xlink`, `xlink:title`, r3);
          break;
        case `xlinkType`:
          Dt2(e3, `http://www.w3.org/1999/xlink`, `xlink:type`, r3);
          break;
        case `xmlBase`:
          Dt2(e3, `http://www.w3.org/XML/1998/namespace`, `xml:base`, r3);
          break;
        case `xmlLang`:
          Dt2(e3, `http://www.w3.org/XML/1998/namespace`, `xml:lang`, r3);
          break;
        case `xmlSpace`:
          Dt2(e3, `http://www.w3.org/XML/1998/namespace`, `xml:space`, r3);
          break;
        case `is`:
          H2(e3, `is`, r3);
          break;
    ...
    function Tf(e3, t3, n3) {
      ...
      var r3 = xf;
      if (r3 && e3 && t3) {
        var i3 = `link[rel="preload"][as="` + W2(t3) + `"]`;
        t3 === `image` && n3 && n3.imageSrcSet ? (i3 += `[imagesrcset="` + W2(n3.imageSrcSet) + `"]`, typeof n3.imageSizes == `string` && (i3 += `[imagesizes="` + W2(n3.imageSizes) + `"]`)) : i3 += `[href="` + W2(e3) + `"]`;
        var a3 = i3;
        switch (t3) {
          case `style`:
            a3 = jf(e3);
    ...
    function Ef(e3, t3) {
      ...
      var n3 = xf;
      if (n3 && e3) {
        var r3 = t3 && typeof t3.as == `string` ? t3.as : `script`, i3 = `link[rel="modulepreload"][as="` + W2(r3) + `"][href="` + W2(e3) + `"]`, a3 = i3;
        switch (r3) {
          case `audioworklet`:
          case `paintworklet`:
          case `serviceworker`:
    ...
    function Lf(e3, t3, n3) {
      if (t3.count++, t3.instance === null) switch (t3.type) {
        case `style`:
          var r3 = e3.querySelector(`style[data-href~="` + W2(n3.href) + `"]`);
      ...
      children: [
        ...
        (0, C.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, C.jsx)(`input`, {
              value: o2,
              onChange: (e3) => s2(e3.target.value),
        ...
        (0, C.jsxs)(`button`, {
          type: `submit`,
          className: `w-full rounded-md ${r2} px-3 py-1.5 text-sm font-medium text-white transition-opacity hover:opacity-90`,
          children: [
            `Set `,
            e2
          ]
...
`,
  ...
  function O(e2) {
    ...
    return t2.endsWith(`.json`) ? D(e2) : t2.endsWith(`.csv`) ? ne(e2) : e2.type.includes(`json`) ? D(e2) : ne(e2);
  }
  function k({ onWaypointsParsed: e2 }) {
        ...
        i2.length > 0 && (0, C.jsxs)(`details`, {
          ...
          children: [
            ...
            (0, C.jsxs)(`ul`, {
              ...
              children: [
                i2.slice(0, 10).map((e3, t3) => (0, C.jsx)(`li`, {
                  children: e3
                }, t3)),
                i2.length > 10 && (0, C.jsxs)(`li`, {
                  children: [
                    `\u2026and `,
                    i2.length - 10,
                    ` more`
  ...
  function A({ waypoints: e2, onRemove: t2 }) {
    return e2.length === 0 ? (0, C.jsx)(`p`, {
      className: `text-xs text-slate-400`,
      children: `No waypoints yet. Upload a CSV or JSON file above.`
    }) : (0, C.jsx)(`ul`, {
      className: `max-h-64 divide-y divide-slate-100 overflow-y-auto rounded-md border border-slate-200`,
      children: e2.map((e3, n2) => (0, C.jsxs)(`li`, {
        ...
        children: [
          ...
          (0, C.jsx)(`button`, {
            onClick: () => t2(n2),
            "aria-label": `Remove waypoint ${n2 + 1}`,
  ...
  function j({ value: e2, max: t2, onChange: n2 }) {
  ...
  var F = `https://www.google.com/maps`;
  function I(e2) {
  ...
  function re(e2) {
    ...
    for (let n2 = 0; n2 < e2.length - 1; n2 += 10) {
      ...
      o2.length > 0 && s2.set(`waypoints`, o2.map(I).join(`|`)), t2.push({
        url: `${F}/dir/?${s2.toString()}`,
        fromIndex: n2,
  ...
  function ae({ route: e2 }) {
    let t2 = e2.orderedWaypoints, n2 = re(t2), r2 = `block rounded-md bg-emerald-600 px-3 py-2 text-center text-sm font-semibold text-white transition-colors hover:bg-emerald-700`;
    return (0, C.jsxs)(`div`, {
      className: `space-y-3`,
      children: [
        (0, C.jsx)(`div`, {
          className: `space-y-1.5`,
          children: n2.length === 1 ? (0, C.jsx)(`a`, {
            href: n2[0].url,
            target: `_blank`,
  ...
  function fe(e2) {
    function t2(t3, n2) {
      ...
      let { children: a2 } = t3;
      return a2 == null ? null : _.createElement(le, {
        value: i2
      }, a2);
    }
  ...
  function pe(e2) {
    function t2(t3, n2) {
      ...
      return o2 ? (0, de.createPortal)(t3.children, o2) : null;
    }
    return (0, _.forwardRef)(t2);
  }
  function me(e2) {
  ...
  function _e(e2, t2) {
    return function(n2, r2) {
      let i2 = ue(), a2 = e2(ge(n2, i2), i2);
      return oe(i2.map, n2.attribution), he(a2.current, n2.eventHandlers), t2(a2.current, i2, n2, r2), a2;
    };
  }
  var ve = o(((e2, t2) => {
    (function(n2, r2) {
      ...
      var pe2 = document.documentElement.style, me2 = `ActiveXObject` in window, he2 = me2 && !document.addEventListener, ge2 = `msLaunchUri` in navigator && !(`documentMode` in document), _e2 = Xe2(`webkit`), ve2 = Xe2(`android`), ye2 = Xe2(`android 2`) || Xe2(`android 3`), be2 = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10), xe2 = ve2 && Xe2(`Google`) && be2 < 537 && !(`AudioNode` in window), Se2 = !!window.opera, Ce2 = !ge2 && Xe2(`chrome`), we2 = Xe2(`gecko`) && !_e2 && !Se2 && !me2, Te2 = !Ce2 && Xe2(`safari`), Ee2 = Xe2(`phantom`), De2 = `OTransition` in pe2, Oe2 = navigator.platform.indexOf(`Win`) === 0, ke2 = me2 && `transition` in pe2, Ae2 = `WebKitCSSMatrix` in window && `m11` in new window.WebKitCSSMatrix() && !ye2, je2 = `MozPerspective` in pe2, Me2 = !window.L_DISABLE_3D && (ke2 || Ae2 || je2) && !De2 && !Ee2, Ne2 = typeof orientation < `u` || Xe2(`mobile`), Pe2 = Ne2 && _e2, Fe2 = Ne2 && Ae2, Ie2 = !window.PointerEvent && window.MSPointerEvent, Le2 = !!(window.PointerEvent || Ie2), Re2 = `ontouchstart` in window || !!window.TouchEvent, ze2 = !window.L_NO_TOUCH && (Re2 || Le2), Be2 = Ne2 && Se2, Ve2 = Ne2 && we2, He2 = (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI) > 1, Ue2 = (function() {
        var e4 = false;
        try {
      ...
      })(), Ge2 = !!(document.createElementNS && de2(`svg`).createSVGRect), Ke2 = !!Ge2 && (function() {
      ...
      function Et2(e4, t4) {
        e4.classList === void 0 ? Dt2(e4, d2((` ` + Ot2(e4) + ` `).replace(` ` + t4 + ` `, ` `))) : e4.classList.remove(t4);
      }
      function Dt2(e4, t4) {
      ...
      function kt2(e4, t4) {
        `opacity` in e4.style ? e4.style.opacity = t4 : `filter` in e4.style && U2(e4, t4);
      }
      function U2(e4, t4) {
      ...
      function jt2(e4, t4, n3) {
        var r3 = t4 || new k2(0, 0);
        e4.style[_t2] = (z2.ie3d ? `translate(` + r3.x + `px,` + r3.y + `px)` : `translate3d(` + r3.x + `px,` + r3.y + `px,0)`) + (n3 ? ` scale(` + n3 + `)` : ``);
      }
      function Mt2(e4, t4) {
        e4._leaflet_pos = t4, z2.any3d ? jt2(e4, t4) : (e4.style.left = t4.x + `px`, e4.style.top = t4.y + `px`);
      }
      function Nt2(e4) {
        return e4._leaflet_pos || new k2(0, 0);
      }
      var W2, Pt2, Ft2;
      if (`onselectstart` in document) W2 = function() {
      ...
      var cn2 = {
        ...
        run: function(e4, t4, n3, r3) {
          this.stop(), this._el = e4, this._inProgress = true, this._duration = n3 || 0.25, this._easeOutPower = 1 / Math.max(r3 || 0.5, 0.2), this._startPos = Nt2(e4), this._offset = t4.subtract(this._startPos), this._startTime = +/* @__PURE__ */ new Date(), this.fire(`start`), this._animate();
        },
        stop: function() {
        ...
        _runFrame: function(e4, t4) {
          ...
          t4 && n3._round(), Mt2(this._el, n3), this.fire(`step`);
        },
        _complete: function() {
        ...
        _rawPanBy: function(e4) {
          Mt2(this._mapPane, this._getMapPanePos().subtract(e4));
        },
        ...
        _getMapPanePos: function() {
          return Nt2(this._mapPane) || new k2(0, 0);
        },
        _moved: function() {
          var e4 = this._getMapPanePos();
          return e4 && !e4.equals([
        ...
        _createAnimProxy: function() {
          ...
          this._panes.mapPane.appendChild(e4), this.on(`zoomanim`, function(e5) {
            ...
            jt2(this._proxy, this.project(e5.center, e5.zoom), this.getZoomScale(e5.zoom, 1)), n3 === this._proxy.style[t4] && this._animatingZoom && this._onZoomTransitionEnd();
        ...
        _animMoveEnd: function() {
          ...
          jt2(this._proxy, this.project(e4, t4), this.getZoomScale(t4, 1));
        },
      ...
      }), dn2.Layers = pn, dn2.Zoom = hn, dn2.Scale = _n, dn2.Attribution = yn, fn.layers = mn, fn.zoom = gn, fn.scale = vn, fn.attribution = function(e4) {
        return new yn(e4);
      };
      var bn = E2.extend({
        initialize: function(e4) {
      ...
      var xn = {
        Events: D2
      }, Sn = z2.touch ? `touchstart mousedown` : `mousedown`, Cn = O2.extend({
        options: {
          clickTolerance: 3
        },
        ...
        enable: function() {
          this._enabled ||= (G2(this._dragStartTarget, Sn, this._onDown, this), true);
        },
        disable: function() {
          this._enabled && (Cn._dragging === this && this.finishDrag(true), K2(this._dragStartTarget, Sn, this._onDown, this), this._enabled = false, this._moved = false);
        },
        _onDown: function(e4) {
          if (this._enabled && (this._moved = false, !Tt2(this._element, `leaflet-zoom-anim`))) {
            ...
            if (!(Cn._dragging || e4.shiftKey || e4.which !== 1 && e4.button !== 1 && !e4.touches) && (Cn._dragging = this, this._preventOutline && Vt2(this._element), Lt2(), W2(), !this._moving)) {
              this.fire(`down`);
              var t4 = e4.touches ? e4.touches[0] : e4, n3 = Ut2(this._element);
              this._startPoint = new k2(t4.clientX, t4.clientY), this._startPos = Nt2(this._element), this._parentScale = Wt2(n3);
        ...
        _updatePosition: function() {
          ...
          this.fire(`predrag`, e4), Mt2(this._element, this._newPos), this.fire(`drag`, e4);
        },
        _onUp: function() {
        ...
        finishDrag: function(e4) {
          ...
          this._moving = false, Cn._dragging = false, t4 && this.fire(`dragend`, {
            noInertia: e4,
      ...
      re2.Earth = ie2, re2.EPSG3395 = qn, re2.EPSG3857 = le2, re2.EPSG900913 = ue2, re2.EPSG4326 = Jn, re2.Simple = Yn;
      var Xn = O2.extend({
        options: {
          pane: `overlayPane`,
          attribution: null,
      ...
      var rr = tr.extend({
        ...
        addHooks: function() {
          ...
          this._draggable ||= new Cn(e4, e4, true), this._draggable.on({
        ...
        _adjustPan: function(e4) {
          var t4 = this._marker, n3 = t4._map, r3 = this._marker.options.autoPanSpeed, i3 = this._marker.options.autoPanPadding, a3 = Nt2(t4._icon), o3 = n3.getPixelBounds(), s3 = n3.getPixelOrigin(), c3 = N2(o3.min._subtract(s3).add(i3), o3.max._subtract(s3).subtract(i3));
          if (!c3.contains(a3)) {
            ...
            n3.panBy(l3, {
              animate: false
            }), this._draggable._newPos._add(l3), this._draggable._startPos._add(l3), Mt2(t4._icon, this._draggable._newPos), this._onDrag(e4), this._panRequest = ee2(this._adjustPan.bind(this, e4));
          }
        },
        ...
        _onDrag: function(e4) {
          var t4 = this._marker, n3 = t4._shadow, r3 = Nt2(t4._icon), i3 = t4._map.layerPointToLatLng(r3);
          n3 && Mt2(n3, r3), t4._latlng = i3, e4.latlng = i3, e4.oldLatLng = this._oldLatLng, t4.fire(`move`, e4).fire(`drag`, e4);
        },
        ...
        _setPos: function(e4) {
          this._icon && Mt2(this._icon, e4), this._shadow && Mt2(this._shadow, e4), this._zIndex = e4.y + this.options.zIndexOffset, this._resetZIndex();
        },
        ...
        _initInteraction: function() {
          if (this.options.interactive && (H2(this._icon, `leaflet-interactive`), this.addInteractiveTarget(this._icon), ir)) {
        ...
        _updateOpacity: function() {
          ...
          this._icon && kt2(this._icon, e4), this._shadow && kt2(this._shadow, e4);
        },
      ...
      var fr = sr.extend({
        ...
        _convertLatLngs: function(e4) {
          for (var t4 = [], n3 = Bn(e4), r3 = 0, i3 = e4.length; r3 < i3; r3++) n3 ? (t4[r3] = R2(e4[r3]), this._bounds.extend(t4[r3])) : t4[r3] = this._convertLatLngs(e4[r3]);
          return t4;
        },
        _project: function() {
          var e4 = new M2();
      ...
      var Dr = Er, Or = Xn.extend({
        ...
        _reset: function() {
          ...
          Mt2(e4, t4.min), e4.style.width = n3.x + `px`, e4.style.height = n3.y + `px`;
        },
        _updateOpacity: function() {
          kt2(this._image, this.options.opacity);
        },
      ...
      var Pr = Xn.extend({
        ...
        onAdd: function(e4) {
          this._zoomAnimated = e4._zoomAnimated, this._container || this._initLayout(), e4._fadeAnimated && kt2(this._container, 0), clearTimeout(this._removeTimeout), this.getPane().appendChild(this._container), this.update(), e4._fadeAnimated && kt2(this._container, 1), this.bringToFront(), this.options.interactive && (H2(this._container, `leaflet-interactive`), this.addInteractiveTarget(this._container));
        },
        onRemove: function(e4) {
          e4._fadeAnimated ? (kt2(this._container, 0), this._removeTimeout = setTimeout(i2(V2, void 0, this._container), 200)) : V2(this._container), this.options.interactive && (Et2(this._container, `leaflet-interactive`), this.removeInteractiveTarget(this._container));
        },
        getLatLng: function() {
          return this._latlng;
        },
        ...
        _updatePosition: function() {
          if (this._map) {
            ...
            this._zoomAnimated ? Mt2(this._container, e4.add(n3)) : t4 = t4.add(e4).add(n3);
      ...
      var Lr = Pr.extend({
        ...
        setOpacity: function(e4) {
          this.options.opacity = e4, this._container && kt2(this._container, e4);
        },
        _animateZoom: function(e4) {
      ...
      var Vr = Xn.extend({
        ...
        _updateOpacity: function() {
          if (this._map && !z2.ielt9) {
            kt2(this._container, this.options.opacity);
            ...
            for (var r3 in this._tiles) {
              ...
              if (!(!i3.current || !i3.loaded)) {
                ...
                kt2(i3.el, a3), a3 < 1 ? t4 = true : (i3.active ? n3 = true : this._onOpaqueTile(i3), i3.active = true);
              }
            }
        ...
        _setZoomTransform: function(e4, t4, n3) {
          ...
          z2.any3d ? jt2(e4.el, i3, r3) : Mt2(e4.el, i3);
        },
        _resetGrid: function() {
        ...
        _initTile: function(e4) {
          ...
          e4.style.width = t4.x + `px`, e4.style.height = t4.y + `px`, e4.onselectstart = l2, e4.onmousemove = l2, z2.ielt9 && this.options.opacity < 1 && kt2(e4, this.options.opacity);
        },
        _addTile: function(e4, t4) {
          ...
          this._initTile(a3), this.createTile.length < 2 && ee2(i2(this._tileReady, this, e4, null, a3)), Mt2(a3, n3), this._tiles[r3] = {
            el: a3,
            coords: e4,
            current: true
        ...
        _tileReady: function(e4, t4, n3) {
          ...
          n3 = this._tiles[r3], n3 && (n3.loaded = +/* @__PURE__ */ new Date(), this._map._fadeAnimated ? (kt2(n3.el, 0), T2(this._fadeFrame), this._fadeFrame = ee2(this._updateOpacity, this)) : (n3.active = true, this._pruneTiles()), t4 || (H2(n3.el, `leaflet-tile-loaded`), this.fire(`tileload`, {
            tile: n3.el,
            coords: e4
      ...
      var Gr = Ur.extend({
        ...
        getTileUrl: function(e4) {
          var t4 = this._tileCoordsToNwSe(e4), n3 = this._crs, r3 = N2(n3.project(t4[0]), n3.project(t4[1])), i3 = r3.min, a3 = r3.max, o3 = (this._wmsVersion >= 1.3 && this._crs === Jn ? [
            i3.y,
            i3.x,
            a3.y,
            a3.x
      ...
      var qr = Xn.extend({
        ...
        _updateTransform: function(e4, t4) {
          ...
          z2.any3d ? jt2(this._container, a3, n3) : Mt2(this._container, a3);
        },
        _reset: function() {
        ...
        _update: function() {
          if (!(this._map._animatingZoom && this._bounds)) {
            ...
            Mt2(t4, e4.min), t4.width = r3 * n3.x, t4.height = r3 * n3.y, t4.style.width = n3.x + `px`, t4.style.height = n3.y + `px`, z2.retina && this._ctx.scale(2, 2), this._ctx.translate(-e4.min.x, -e4.min.y), this.fire(`update`);
          }
        },
        _reset: function() {
      ...
      var Xr = (function() {
        ...
        _update: function() {
          if (!(this._map._animatingZoom && this._bounds)) {
            ...
            (!this._svgSize || !this._svgSize.equals(t4)) && (this._svgSize = t4, n3.setAttribute(`width`, t4.x), n3.setAttribute(`height`, t4.y)), Mt2(n3, e4.min), n3.setAttribute(`viewBox`, [
              e4.min.x,
              e4.min.y,
              t4.x,
              t4.y
      ...
      var ri = bn.extend({
        ...
        _onMouseDown: function(e4) {
          ...
          this._clearDeferredResetState(), this._resetState(), W2(), Lt2(), this._startPoint = this._map.mouseEventToContainerPoint(e4), G2(document, {
            contextmenu: tn2,
        ...
        _onMouseMove: function(e4) {
          ...
          Mt2(this._box, t4.min), this._box.style.width = n3.x + `px`, this._box.style.height = n3.y + `px`;
        },
        _finish: function() {
      ...
      var ai = bn.extend({
        addHooks: function() {
          if (!this._draggable) {
            var e4 = this._map;
            this._draggable = new Cn(e4._mapPane, e4._container), this._draggable.on({
              dragstart: this._onDragStart,
              drag: this._onDrag,
              dragend: this._onDragEnd
      ...
      q2.addInitHook(`addHandler`, `touchZoom`, ui), q2.BoxZoom = ri, q2.DoubleClickZoom = ii, q2.Drag = ai, q2.Keyboard = oi, q2.ScrollWheelZoom = si, q2.TapHold = li, q2.TouchZoom = ui, e3.Bounds = M2, e3.Browser = z2, e3.CRS = re2, e3.Canvas = Jr, e3.Circle = ur, e3.CircleMarker = cr, e3.Class = E2, e3.Control = dn2, e3.DivIcon = zr, e3.DivOverlay = Pr, e3.DomEvent = cn2, e3.DomUtil = Gt2, e3.Draggable = Cn, e3.Evented = O2, e3.FeatureGroup = $n, e3.GeoJSON = gr, e3.GridLayer = Vr, e3.Handler = bn, e3.Icon = tr, e3.ImageOverlay = Or, e3.LatLng = I2, e3.LatLngBounds = P2, e3.Layer = Xn, e3.LayerGroup = Zn, e3.LineUtil = Un, e3.Map = q2, e3.Marker = ar, e3.Mixin = xn, e3.Path = sr, e3.Point = k2, e3.PolyUtil = Dn, e3.Polygon = mr, e3.Polyline = fr, e3.Popup = Fr, e3.PosAnimation = ln2, e3.Projection = Kn, e3.Rectangle = ti, e3.Renderer = qr, e3.SVG = $r, e3.SVGOverlay = Mr, e3.TileLayer = Ur, e3.Tooltip = Lr, e3.Transformation = se2, e3.Util = te2, e3.VideoOverlay = Ar, e3.bind = i2, e3.bounds = N2, e3.canvas = Yr, e3.circle = dr, e3.circleMarker = lr, e3.control = fn, e3.divIcon = Br, e3.extend = n2, e3.featureGroup = er, e3.geoJSON = Er, e3.geoJson = Dr, e3.gridLayer = Hr, e3.icon = nr, e3.imageOverlay = kr, e3.latLng = R2, e3.latLngBounds = F2, e3.layerGroup = Qn, e3.map = un2, e3.marker = or, e3.point = j2, e3.polygon = hr, e3.polyline = pr, e3.popup = Ir, e3.rectangle = ni, e3.setOptions = p2, e3.stamp = o2, e3.svg = ei, e3.svgOverlay = Nr, e3.tileLayer = Wr, e3.tooltip = Rr, e3.transformation = ce2, e3.version = t3, e3.videoOverlay = jr;
      var di = window.L;
  ...
  function Se(e2) {
    return function(t2) {
      let n2 = ue(), r2 = e2(ge(t2, n2), n2);
      return oe(n2.map, t2.attribution), he(r2.current, t2.eventHandlers), xe(r2.current, n2), r2;
    };
  }
  function Ce(e2, t2) {
    let n2 = (0, _.useRef)(void 0);
  ...
  function we(e2) {
    return function(t2) {
      let n2 = ue(), r2 = e2(ge(t2, n2), n2);
      return he(r2.current, t2.eventHandlers), xe(r2.current, n2), Ce(r2.current, t2), r2;
    };
  }
  function Te(e2, t2) {
    return fe(Se(be(e2, t2)));
  }
  function Ee(e2, t2) {
    return pe(_e(be(e2), t2));
  }
  function De(e2, t2) {
    return fe(we(be(e2, t2)));
  }
  function Oe(e2, t2) {
    return me(Se(be(e2, t2)));
  }
  ...
  var je = c(ve(), 1);
  function Me({ bounds: e2, boundsOptions: t2, center: n2, children: r2, className: i2, id: a2, placeholder: o2, style: s2, whenReady: c2, zoom: l2, ...u2 }, d2) {
    let [f2] = (0, _.useState)({
      className: i2,
      id: a2,
      style: s2
    ...
    let g2 = (0, _.useCallback)((r3) => {
      if (r3 !== null && !h2.current) {
        let i3 = new je.Map(r3, u2);
        h2.current = i3, n2 != null && l2 != null ? i3.setView(n2, l2) : e2 != null && i3.fitBounds(e2, t2), c2 != null && i3.whenReady(c2), m2(se(i3));
      }
    }, []);
    (0, _.useEffect)(() => () => {
      p2?.map.remove();
  ...
  var Ne = (0, _.forwardRef)(Me), Pe = Te(function({ position: e2, ...t2 }, n2) {
    let r2 = new je.Marker(e2, t2);
    return ye(r2, ce(n2, {
      overlayContainer: r2
    }));
  }, function(e2, t2, n2) {
  ...
  }), Fe = De(function({ positions: e2, ...t2 }, n2) {
    let r2 = new je.Polyline(e2, t2);
    return ye(r2, ce(n2, {
      overlayContainer: r2
    }));
  }, function(e2, t2, n2) {
    t2.positions !== n2.positions && e2.setLatLngs(t2.positions);
  }), Ie = Ee(function(e2, t2) {
    return ye(new je.Popup(e2, t2.overlayContainer), t2);
  ...
  }), Le = Oe(function({ url: e2, ...t2 }, n2) {
    return ye(new je.TileLayer(e2, ge(t2, n2)), n2);
  }, function(e2, t2, n2) {
    ke(e2, t2, n2);
    let { url: r2 } = t2;
  ...
  var ze = Re(`#059669`, `S`), Be = Re(`#e11d48`, `E`);
  function Ve({ points: e2, fitKey: t2 }) {
    let n2 = Ae();
    return (0, _.useEffect)(() => {
      ...
      let t3 = je.default.latLngBounds(e2.map((e3) => [
        e3.lat,
        e3.lng
      ]));
      n2.fitBounds(t3, {
  ...
  function He({ startLocation: e2, endLocation: t2, waypoints: n2, optimizedRoute: r2 }) {
    let i2 = (0, _.useMemo)(() => r2 ? r2.orderedWaypoints.slice(1, -1).map((e3, t3) => ({
      point: e3,
      number: t3 + 2,
      optimized: true
    })) : n2.map((e3, t3) => ({
    ...
    return (0, C.jsxs)(Ne, {
      ...
      children: [
        ...
        i2.map((e3, t3) => (0, C.jsx)(Pe, {
          position: [
            e3.point.lat,
            e3.point.lng
          ],
          icon: Re(`#2563eb`, String(e3.number)),
          children: (0, C.jsxs)(Ie, {
            children: [
              (0, C.jsx)(`strong`, {
                children: e3.optimized ? `Stop ${e3.number} (optimized)` : `Waypoint ${e3.number}`
              }),
              (0, C.jsx)(`br`, {}),
              x(e3.point)
            ]
  ...
  var Ue = `https://router.project-osrm.org/table/v1/driving`, We = `https://router.project-osrm.org/route/v1/driving`, Ge = 9999999, Ke = 1e4, qe = 1100, Je = 300, Ye = (e2) => new Promise((t2) => setTimeout(t2, e2));
  async function Xe(e2, t2 = 3e4) {
  ...
  async function z(e2, t2, n2, r2) {
    let i2 = [
      e2,
      ...t2,
      n2
    ], a2 = i2.length;
    if (a2 < 2) throw Error(`At least a start and an end location are required.`);
    if (a2 > Je) throw Error(`Too many points (${a2}). This client supports up to ${Je} (start + ${Je - 2} stops + end).`);
    let o2 = i2.map((e3) => `${e3.lng},${e3.lat}`).join(`;`), s2 = Math.max(1, Math.floor(Ke / a2)), c2 = Math.ceil(a2 / s2), l2 = [];
    for (let e3 = 0; e3 < c2; e3++) {
      let t3 = e3 * s2, n3 = Math.min(a2, t3 + s2), i3 = Array.from({
        length: n3 - t3
      }, (e4, n4) => t3 + n4).join(`;`), u2 = await Xe(`${Ue}/${o2}?annotations=duration` + (c2 > 1 ? `&sources=${i3}` : ``));
      if (!u2.ok) throw Error(`OSRM table request failed: ${u2.status} ${u2.statusText}`);
      let d2 = await u2.json();
      if (d2.code !== `Ok` || !d2.durations) throw Error(`OSRM could not build a duration matrix (${d2.message ?? d2.code}).`);
      for (let e4 of d2.durations) l2.push(e4);
      r2?.(e3 + 1, c2), e3 < c2 - 1 && await Ye(qe);
    }
    return l2.map((e3) => e3.map((e4) => e4 == null ? Ge : Math.round(e4)));
  }
  async function Ze(e2) {
    if (e2.length < 2) throw Error(`A route needs at least two points.`);
    let t2 = await Xe(`${We}/${e2.map((e3) => `${e3.lng},${e3.lat}`).join(`;`)}?overview=full&geometries=geojson`);
  ...
  function et(e2 = $e()) {
    return e2 === `browser-main` || e2 === `bun` || e2 === `deno` ? `asyncify` : Qe() ? `jspi` : `asyncify`;
  }
  function tt(e2) {
    let t2 = {}, n2 = null;
    function r2() {
      return n2 || (n2 = et(), e2.logFlavorSelection && console.log(n2 === `jspi` ? `JSPI is supported. Using JSPI runtime.` : `Using Asyncify runtime.`), n2);
    }
  ...
  var nt = `modulepreload`, rt = function(e2) {
    return `/optimiser/` + e2;
  }, it = {}, at = function(e2, t2, n2) {
    ...
    if (t2 && t2.length > 0) {
      ...
      r2 = o2(t2.map((t3) => {
        if (t3 = rt(t3, n2), t3 = s2(t3), t3 in it) return;
        it[t3] = true;
        ...
        if (i4.rel = r3 ? `stylesheet` : nt, r3 || (i4.as = `script`), i4.crossOrigin = ``, i4.href = t3, a2 && i4.setAttribute(`nonce`, a2), document.head.appendChild(i4), r3) return new Promise((e4, n3) => {
  ...
  function lt(e2) {
    for (let t2 of Object.values(ot)) for (let n2 of Object.values(t2)) {
      if (e2 === ct(n2.jsUrl)) return n2.jsUrl;
      if (e2 === ct(n2.wasmUrl)) return n2.wasmUrl;
    }
    return e2;
  }
  var ut = tt({
    ...
    async resolveAsset(e2, t2) {
      let n2 = ot[e2][t2], r2 = new Uint8Array(await (await fetch(n2.wasmUrl)).arrayBuffer());
      return {
        jsUrl: n2.jsUrl,
        locateFile: lt,
        wasmBinary: r2,
  ...
  ut.terminateLoadedRuntimeThreads, ut.loadRuntime, ut.loadRuntimeAsyncify;
  var dt = ut.loadRoutingRuntime;
  ut.loadRoutingRuntimeAsyncify, ut.loadMPSolverRuntime, ut.loadMPSolverRuntimeAsyncify, ut.loadMathOptRuntime, ut.loadMathOptRuntimeAsyncify, ut.loadPdlpRuntime, ut.loadPdlpRuntimeAsyncify, ut.loadGraphRuntime, ut.loadGraphRuntimeAsyncify, ut.loadSetCoverRuntime, ut.loadSetCoverRuntimeAsyncify;
  var ft = typeof window < `u` && typeof document < `u`, pt = `Deno` in globalThis, mt = `Bun` in globalThis, ht = typeof process < `u` && typeof process.versions?.node == `string` && !pt && !mt, gt = (ft || pt || mt) && typeof Worker < `u` || ht, _t = null, vt = null, yt = ft && gt, bt = 1, xt = /* @__PURE__ */ new Map();
  function B() {
    return yt && gt;
  }
  function V() {
  ...
  function St(e2) {
    if (yt = !!e2, yt && !gt) throw yt = false, Error(`Worker bridge requested but no worker is available in this environment.`);
    yt || wt(`OR-Tools worker bridge disabled.`);
  }
  function Ct() {
    return bt++;
  }
  function wt(e2) {
    if (!_t) return;
    _t.terminate(), _t = null, vt = null;
    let t2 = Error(e2 ?? `OR-Tools worker terminated.`);
    for (let e3 of xt.values()) e3.reject(t2);
    xt.clear();
  }
  async function Tt() {
  ...
  async function H() {
    if (!gt) throw Error(`Worker bridge is not available.`);
    if (_t) return _t;
    let e2 = await Tt();
    return e2.unref?.(), _t = e2, vt = new Promise((t2, n2) => {
      let r2 = (e3) => {
        if (e3.type === `ready`) {
          t2();
          return;
        ...
        if (e3.type === `solveCallback`) {
          if (r3?.onEvent) try {
            ...
            xt.delete(e3.id), r3.reject(t3);
          }
          return;
        }
        if (e3.type === `error`) {
          let t3 = Error(e3.error);
          r3 ? (r3.reject(t3), xt.delete(e3.id)) : n2(t3);
          return;
        }
        r3 && (xt.delete(e3.id), r3.resolve(e3));
      }, i2 = (e3) => {
  ...
  async function Et() {
    if (!gt) throw Error(`Worker bridge is not available.`);
    if (await H(), !vt) throw Error(`Worker ready state unavailable.`);
    await vt;
  }
  async function Dt(e2, t2) {
    if (!gt) throw Error(`Worker bridge is not available.`);
    let n2 = await H();
    return await Et(), new Promise((r2, i2) => {
      xt.set(e2.id, {
        resolve: (e3) => r2(e3),
        reject: i2,
        onEvent: t2
  ...
  var Ot = Object.defineProperty, kt = (e2, t2, n2) => t2 in e2 ? Ot(e2, t2, {
    enumerable: true,
    configurable: true,
    writable: true,
    value: n2
  }) : e2[t2] = n2, U = (e2, t2, n2) => kt(e2, typeof t2 == `symbol` ? t2 : t2 + ``, n2), At = 1, jt = null, Mt = null;
  function Nt(e2) {
  ...
  function Ft(e2) {
    return new BigInt64Array(e2.map((e3) => W(e3)));
  }
  function It(e2) {
  ...
  function qt(e2) {
    return typeof e2 == `object` && !!e2 && e2.type === `routingVehicleEquality` && Kt(e2.left) && Kt(e2.right);
  }
  function Jt(e2) {
    return typeof e2 == `object` && !!e2 && e2.type === `routingCumulLessOrEqual` && K(e2.left) && K(e2.right);
  }
  var Yt = class {
    constructor(e2, t2, n2, r2) {
      if (U(this, `ready`, Promise.resolve()), U(this, `module`, null), U(this, `handle`, 0), U(this, `indexToNodeMap`, []), U(this, `nodeToIndexMap`, /* @__PURE__ */ new Map()), U(this, `startIndices`, []), U(this, `endIndices`, []), U(this, `numLocations`), U(this, `numVehicles`), U(this, `starts`), U(this, `ends`), this.numLocations = e2, this.numVehicles = t2, Array.isArray(n2)) {
      ...
      if (this.createSyntheticIndexMapping(), Bt() && (this.module = Ht(), this.handle = Array.isArray(n2) ? this.createStartsEndsManager(this.starts, this.ends) : this.module._routing_create_index_manager(this.numLocations, this.numVehicles, n2), this.handle === 0)) throw Error(`RoutingIndexManager: failed to create native manager.`);
    }
    get depot() {
    ...
    indexToNodeSync(e2) {
      ...
      return Nt(this.module._routing_manager_index_to_node(this.nativeHandle, W(e2)));
    }
    IndexToNode(e2) {
    ...
    nodeToIndexSync(e2) {
      return this.module ? Nt(this.module._routing_manager_node_to_index(this.nativeHandle, e2)) : this.nodeToIndexMap.get(e2) ?? -1;
    }
    NodeToIndex(e2) {
    ...
    GetStartIndex(e2) {
      return this.module ? Nt(this.module._routing_manager_start_index(this.nativeHandle, e2)) : this.startIndices[e2];
    }
    GetEndIndex(e2) {
      return this.module ? Nt(this.module._routing_manager_end_index(this.nativeHandle, e2)) : this.endIndices[e2];
    }
    delete() {
    ...
    createStartsEndsManager(e2, t2) {
      ...
      try {
        return this.module.HEAPU8.set(Pt(e2), r2), this.module.HEAPU8.set(Pt(t2), i2), this.module._routing_create_index_manager_starts_ends(this.numLocations, this.numVehicles, r2, i2);
      } finally {
    ...
    constructor(e2, t2) {
      U(this, `routing`, e2), U(this, `name`, t2), U(this, `softSpanUpperBounds`, /* @__PURE__ */ new Map()), U(this, `quadraticCostSoftSpanUpperBounds`, /* @__PURE__ */ new Map());
    }
    CumulVar(e2) {
      return {
    ...
    SetSoftSpanUpperBoundForVehicle(e2, t2) {
      if (!this.routing.hasNativeModule()) {
        this.softSpanUpperBounds.set(t2, new G(e2.bound, e2.cost));
        return;
      }
      this.routing.withCString(this.name, (n2) => {
        this.routing.moduleRef._routing_dimension_set_soft_span_upper_bound(this.routing.nativeHandle, n2, W(e2.bound), W(e2.cost), t2);
      });
    }
    GetSoftSpanUpperBoundForVehicle(e2) {
      return this.routing.hasNativeModule() ? this.routing.withCString(this.name, (t2) => new G(Nt(this.routing.moduleRef._routing_dimension_get_soft_span_upper_bound_bound(this.routing.nativeHandle, t2, e2)), Nt(this.routing.moduleRef._routing_dimension_get_soft_span_upper_bound_cost(this.routing.nativeHandle, t2, e2)))) : this.softSpanUpperBounds.get(e2) ?? new G(0, 0);
    }
    ...
    SetQuadraticCostSoftSpanUpperBoundForVehicle(e2, t2) {
      if (!this.routing.hasNativeModule()) {
        this.quadraticCostSoftSpanUpperBounds.set(t2, new G(e2.bound, e2.cost));
        return;
      }
      this.routing.withCString(this.name, (n2) => {
        this.routing.moduleRef._routing_dimension_set_quadratic_cost_soft_span_upper_bound(this.routing.nativeHandle, n2, W(e2.bound), W(e2.cost), t2);
      });
    }
    GetQuadraticCostSoftSpanUpperBoundForVehicle(e2) {
      return this.routing.hasNativeModule() ? this.routing.withCString(this.name, (t2) => new G(Nt(this.routing.moduleRef._routing_dimension_get_quadratic_cost_soft_span_upper_bound_bound(this.routing.nativeHandle, t2, e2)), Nt(this.routing.moduleRef._routing_dimension_get_quadratic_cost_soft_span_upper_bound_cost(this.routing.nativeHandle, t2, e2)))) : this.quadraticCostSoftSpanUpperBounds.get(e2) ?? new G(0, 0);
    }
  }, Zt = class {
    constructor(e2, t2 = null) {
      U(this, `routing`, e2), U(this, `workerResult`, t2);
    }
    ObjectiveValue() {
    ...
    constructor(e2, t2) {
      if (U(this, `manager`, e2), U(this, `ready`, Promise.resolve()), U(this, `module`, null), U(this, `handle`, 0), U(this, `callbackIds`, /* @__PURE__ */ new Set()), U(this, `transitCallbacks`, /* @__PURE__ */ new Map()), U(this, `arcCostEvaluatorIndex`, null), U(this, `lastWorkerResult`, null), U(this, `evaluatorCallbacks`, /* @__PURE__ */ new Map()), U(this, `nextWorkerEvaluatorIndex`, 1), U(this, `operations`, []), U(this, `dimensionNames`, /* @__PURE__ */ new Set()), U(this, `atSolutionCallbacks`, []), U(this, `lastObjectiveValue`, 0), U(this, `lastWorkerStatus`, null), U(this, `parameters`), this.parameters = t2, Bt() && (this.module = Ht(), this.handle = this.module._routing_create_model(this.manager.nativeHandle), this.handle === 0)) throw Error(`RoutingModel: failed to create native model.`);
    }
    ...
    async solveWithWorkerRequest(e2) {
      ...
      let n2 = new Zt(this, t2.result);
      return this.lastObjectiveValue = n2.ObjectiveValue(), this.runAtSolutionCallbacks(), n2;
    }
    async SolveWithParameters(e2 = Gt()) {
      if (B()) return this.solveWithWorkerRequest(e2);
    ...
    async Solve() {
      return this.SolveWithParameters(Gt());
    }
    solveWithParametersSync(e2 = Gt()) {
    ...
    Start(e2) {
      return this.lastWorkerResult?.starts[e2] === void 0 ? this.module ? Nt(this.module._routing_start(this.handle, e2)) : this.manager.GetStartIndex(e2) : this.lastWorkerResult.starts[e2];
    }
    End(e2) {
      return this.lastWorkerResult?.ends[e2] === void 0 ? this.module ? Nt(this.module._routing_end(this.handle, e2)) : this.manager.GetEndIndex(e2) : this.lastWorkerResult.ends[e2];
    }
    IsEnd(e2) {
      return this.lastWorkerResult ? this.lastWorkerResult.ends.includes(e2) : this.module ? this.module._routing_is_end(this.handle, W(e2)) === 1 : this.manager.ends.some((t2, n2) => this.manager.GetEndIndex(n2) === e2);
    }
    ...
    AddDimension(e2, t2, n2, r2, i2) {
      ...
      let a2 = this.withCString(i2, (i3) => this.moduleRef._routing_add_dimension(this.handle, e2, W(t2), W(n2), +!!r2, i3) === 1);
    ...
    AddDimensionWithVehicleCapacity(e2, t2, n2, r2, i2) {
      ...
      let a2 = Ft(n2), o2 = new Uint8Array(a2.buffer, a2.byteOffset, a2.byteLength), s2 = this.module._malloc(o2.byteLength);
      this.module.HEAPU8.set(o2, s2);
      try {
        let o3 = this.withCString(i2, (n3) => this.moduleRef._routing_add_dimension_with_vehicle_capacity(this.handle, e2, W(t2), s2, a2.length, +!!r2, n3) === 1);
    ...
    AddDimensionWithVehicleTransits(e2, t2, n2, r2, i2) {
      ...
      let a2 = Pt(e2), o2 = this.module._malloc(a2.byteLength);
      this.module.HEAPU8.set(a2, o2);
      try {
        let a3 = this.withCString(i2, (i3) => this.moduleRef._routing_add_dimension_with_vehicle_transits(this.handle, o2, e2.length, W(t2), W(n2), +!!r2, i3) === 1);
    ...
    AddConstantDimension(e2, t2, n2, r2) {
      ...
      let i2 = this.withCString(r2, (r3) => this.moduleRef._routing_add_constant_dimension(this.handle, W(e2), W(t2), +!!n2, r3)), a2 = i2 >= 0;
    ...
    AddVectorDimension(e2, t2, n2, r2) {
      ...
      let i2 = Ft(e2), a2 = new Uint8Array(i2.buffer, i2.byteOffset, i2.byteLength), o2 = this.module._malloc(a2.byteLength);
      this.module.HEAPU8.set(a2, o2);
      try {
        let a3 = this.withCString(r2, (e3) => this.moduleRef._routing_add_vector_dimension(this.handle, o2, i2.length, W(t2), +!!n2, e3)), s2 = a3 >= 0;
    ...
    AddMatrixDimension(e2, t2, n2, r2) {
      ...
      let i2 = Ft(e2.flat()), a2 = new Uint8Array(i2.buffer, i2.byteOffset, i2.byteLength), o2 = this.module._malloc(a2.byteLength);
      this.module.HEAPU8.set(a2, o2);
      try {
        let a3 = this.withCString(r2, (r3) => this.moduleRef._routing_add_matrix_dimension(this.handle, o2, i2.length, e2.length, W(t2), +!!n2, r3)), s2 = a3 >= 0;
        return s2 && (this.dimensionNames.add(r2), this.operations.push({
          type: `addMatrixDimension`,
          matrix: e2,
          capacity: t2,
    ...
    AddDisjunction(e2, t2) {
      ...
      let n2 = Ft(e2), r2 = new Uint8Array(n2.buffer, n2.byteOffset, n2.byteLength), i2 = this.module._malloc(r2.byteLength);
      this.module.HEAPU8.set(r2, i2);
      try {
        let r3 = this.module._routing_add_disjunction(this.handle, i2, n2.length, W(t2 ?? 0), t2 === void 0 ? 0 : 1);
    ...
    GetNumberOfDecisionsInFirstSolution(e2) {
      ...
      let t2 = Nt(this.module._routing_get_number_of_decisions_in_first_solution(this.handle, e2.firstSolutionStrategy ?? 0, e2.solution_limit ?? 0));
      return t2 === 0 && e2.firstSolutionStrategy === 10 ? this.manager.GetNumberOfIndices() : t2;
    }
    GetNumberOfRejectsInFirstSolution(e2) {
      return this.module ? Nt(this.module._routing_get_number_of_rejects_in_first_solution(this.handle, e2.firstSolutionStrategy ?? 0, e2.solution_limit ?? 0)) : 0;
    }
    ...
    ReadAssignmentFromRoutes(e2, t2) {
      if (!this.module) {
        ...
        return this.lastWorkerResult = n3, this.lastWorkerStatus = 1, this.lastObjectiveValue = n3.objectiveValue, new Zt(this, n3);
      }
      let n2 = e2.map((e3) => e3.length), r2 = Ft(e2.flat()), i2 = new Uint8Array(r2.buffer, r2.byteOffset, r2.byteLength), a2 = Pt(n2), o2 = this.module._malloc(i2.byteLength), s2 = this.module._malloc(a2.byteLength);
    ...
    AddPickupAndDelivery(e2, t2) {
      ...
      this.module._routing_add_pickup_and_delivery(this.handle, W(e2), W(t2)), this.operations.push({
        type: `addPickupAndDelivery`,
        pickup: e2,
        delivery: t2
      });
    ...
    addSolverConstraint(e2) {
      if (this.module) {
        if (qt(e2)) {
          if (this.module._routing_add_vehicle_equality_constraint(this.handle, W(e2.left.index), W(e2.right.index)) !== 1) throw Error(`RoutingModel.solver().Add: failed to add vehicle equality constraint.`);
          return;
        }
        if (Jt(e2)) {
          ...
          if (this.withCString(e2.left.dimensionName, (t2) => this.moduleRef._routing_add_dimension_cumul_less_or_equal_constraint(this.handle, t2, W(e2.left.index), W(e2.right.index))) !== 1) throw Error(`RoutingModel.solver().Add: failed to add cumul precedence constraint.`);
        }
      }
    }
    GetArcCostForVehicle(e2, t2, n2) {
      ...
      return Nt(this.module._routing_get_arc_cost_for_vehicle(this.handle, W(e2), W(t2), n2));
    }
    assignmentObjectiveValue() {
      return this.module ? Nt(this.module._routing_assignment_objective_value(this.handle)) : this.lastObjectiveValue;
    }
    nextValue(e2) {
      return this.lastWorkerResult ? this.lastWorkerResult.nextValues[e2] : this.module ? Nt(this.module._routing_next_value(this.handle, W(e2))) : e2;
    }
    dimensionCumulValue(e2, t2) {
      return this.module ? this.withCString(e2, (e3) => Nt(this.moduleRef._routing_assignment_dimension_cumul_value(this.handle, e3, W(t2)))) : this.lastWorkerResult?.dimensionCumulValues[e2]?.[t2] ?? 0;
    }
    delete() {
      for (let e2 of this.callbackIds) this.module?.__routingTransitCallbacks?.delete(e2);
      this.transitCallbacks.clear(), this.callbackIds.clear(), this.handle !== 0 && (this.module && zt() && this.module._routing_delete_model(this.handle), this.handle = 0);
    }
    ...
    buildTransitMatrixFromCallback(e2) {
      ...
      for (let r2 = 0; r2 < t2; r2++) for (let i2 = 0; i2 < t2; i2++) n2[r2 * t2 + i2] = W(e2(r2, i2));
      return n2;
    }
    ...
    withCString(e2, t2) {
      if (!this.module) throw Error(`RoutingModel: native routing module is not available in worker bridge mode.`);
      let n2 = It(e2), r2 = this.module._malloc(n2.byteLength);
  ...
  async function nn(e2, t2) {
    let n2 = e2.length;
    if (n2 < 2) throw Error(`Matrix must contain at least a start and an end node.`);
    let r2 = n2 - 1, i2 = Math.max(0, Math.floor(t2));
    await tn(), await new Promise((e3) => setTimeout(e3, 0));
    let a2 = new Yt(n2, 1, [
      0
    ], [
      r2
    ...
    try {
      let t3 = o2.RegisterTransitCallback((t4, n4) => {
        let r3 = a2.IndexToNode(t4), i3 = a2.IndexToNode(n4);
        return e2[r3][i3];
      });
      o2.SetArcCostEvaluatorOfAllVehicles(t3);
      for (let e3 = 1; e3 < r2; e3++) o2.AddDisjunction([
        a2.NodeToIndex(e3)
      ], $t);
      let n3 = o2.RegisterUnaryTransitCallback((e3) => {
        let t4 = a2.IndexToNode(e3);
        return t4 === 0 || t4 === r2 ? 0 : 1;
      });
      o2.AddDimensionWithVehicleCapacity(n3, 0, [
        i2
      ], true, `StopCounter`);
      let s2 = Gt();
      s2.firstSolutionStrategy = Wt.PATH_CHEAPEST_ARC;
      let c2 = await o2.SolveWithParameters(s2);
      if (!c2) throw Error(`OR-Tools could not find a feasible route for this K.`);
      let l2 = [], u2 = o2.Start(0);
      for (l2.push(a2.IndexToNode(u2)); !o2.IsEnd(u2); ) u2 = c2.Value(o2.NextVar(u2)), l2.push(a2.IndexToNode(u2));
      return l2;
    } finally {
      o2.delete(), a2.delete();
    }
  ...
  function on(e2, t2) {
    let n2 = an(t2.lat - e2.lat), r2 = an(t2.lng - e2.lng), i2 = Math.sin(n2 / 2) ** 2 + Math.cos(an(e2.lat)) * Math.cos(an(t2.lat)) * Math.sin(r2 / 2) ** 2;
    return 2 * rn * Math.asin(Math.sqrt(i2));
  }
  async function sn(e2, t2, n2, r2, i2) {
    let a2 = [
      e2,
      ...t2,
      n2
    ];
    i2?.(`Fetching cost matrix\u2026`);
    let o2 = await z(e2, t2, n2, (e3, t3) => {
      i2?.(t3 > 1 ? `Fetching cost matrix\u2026 ${e3}/${t3}` : `Fetching cost matrix\u2026`);
    });
    i2?.(`Optimizing route\u2026`);
    let s2 = await nn(o2, r2), c2 = s2.map((e3) => a2[e3]), l2 = 0;
    for (let e3 = 0; e3 < s2.length - 1; e3++) l2 += o2[s2[e3]][s2[e3 + 1]];
    i2?.(`Building road route\u2026`);
    try {
      let e3 = await Ze(c2);
      return {
        orderedWaypoints: c2,
      ...
      let e3 = 0;
      for (let t3 = 0; t3 < c2.length - 1; t3++) e3 += on(c2[t3], c2[t3 + 1]);
      return {
        orderedWaypoints: c2,
        geometry: {
          type: `LineString`,
          coordinates: c2.map((e4) => [
            e4.lng,
            e4.lat
          ])
        },
  ...
  var cn = `route-optimiser:v1`;
  function ln() {
    try {
      let e2 = localStorage.getItem(cn);
      if (!e2) return {};
      let t2 = JSON.parse(e2);
      return t2 && typeof t2 == `object` ? t2 : {};
    } catch {
      return {};
    }
  }
  function q(e2) {
    try {
      localStorage.setItem(cn, JSON.stringify(e2));
    } catch {
    }
  }
  function un() {
  ...
  function dn() {
    let e2 = (0, _.useMemo)(() => ln(), []), [t2, n2] = (0, _.useState)(e2.startLocation ?? null), [r2, i2] = (0, _.useState)(e2.endLocation ?? null), [a2, o2] = (0, _.useState)(e2.waypoints ?? []), [s2, c2] = (0, _.useState)(e2.targetK ?? null), [l2, u2] = (0, _.useState)(e2.optimizedRoute ?? null), [d2, f2] = (0, _.useState)(null), [p2, m2] = (0, _.useState)(false), [h2, g2] = (0, _.useState)(null), [v2, y2] = (0, _.useState)(false), [b2, x2] = (0, _.useState)(null);
    (0, _.useEffect)(() => {
      let e3 = setTimeout(() => {
        window.crossOriginIsolated ? tn().then(() => y2(true)).catch((e4) => x2(e4.message)) : x2(`This browser did not enable the isolation the optimizer needs (SharedArrayBuffer). Please use the latest Chrome or Edge.`);
      }, 3e3);
      return () => clearTimeout(e3);
    }, []), (0, _.useEffect)(() => {
      !t2 && !r2 && a2.length === 0 && !l2 ? un() : q({
        startLocation: t2,
        endLocation: r2,
        waypoints: a2,
        targetK: s2,
    ...
    let S2 = (e3) => o2((t3) => [
      ...t3,
      ...e3
    ]), ee2 = (e3) => o2((t3) => t3.filter((t4, n3) => n3 !== e3)), T2 = () => o2([]);
    function te2() {
      n2(null), i2(null), o2([]), c2(null), u2(null), f2(null);
    }
    let E2 = !!(t2 || r2 || a2.length > 0 || l2), ne2 = !!(t2 && r2) && !p2;
    async function D2() {
      if (!(!t2 || !r2)) {
        m2(true), f2(null), g2(null);
        try {
          let e3 = s2 ?? a2.length, n3 = await sn(t2, a2, r2, e3, g2);
          u2(n3), y2(true);
        } catch (e3) {
          u2(null), f2(e3.message);
        } finally {
          m2(false), g2(null);
        }
      }
    ...
    return (0, C.jsxs)(`div`, {
      ...
      children: [
        (0, C.jsxs)(`aside`, {
          className: `flex w-96 shrink-0 flex-col gap-5 overflow-y-auto border-r border-slate-200 bg-white p-5`,
          children: [
            (0, C.jsxs)(`header`, {
              children: [
                (0, C.jsxs)(`div`, {
            ...
            (0, C.jsxs)(`section`, {
              ...
              children: [
                (0, C.jsx)(`h2`, {
                  className: `text-sm font-semibold text-slate-700`,
                  children: `Upload waypoints`
                }),
                (0, C.jsx)(k, {
                  onWaypointsParsed: S2
                })
              ]
            }),
            (0, C.jsxs)(`section`, {
            ...
            (0, C.jsxs)(`section`, {
              ...
              children: [
                (0, C.jsx)(`button`, {
                  onClick: D2,
                  disabled: !ne2,
                  className: `w-full rounded-md px-3 py-2 text-sm font-semibold text-white transition-colors disabled:cursor-not-allowed ${p2 ? `animate-pulse bg-blue-500` : `bg-blue-600 hover:bg-blue-700 disabled:bg-slate-300`}`,
                  children: p2 ? h2 ?? `Calculating\u2026` : `Calculate Route`
                }),
                !t2 || !r2 ? (0, C.jsx)(`p`, {
                  className: `text-xs text-slate-400`,
                  children: `Set both a start and an end location to calculate.`
                }) : !p2 && !v2 ? (0, C.jsx)(`p`, {
                  className: `text-xs text-slate-400`,
                ...
                l2 && (0, C.jsxs)(C.Fragment, {
                  children: [
                    (0, C.jsxs)(`p`, {
                      className: `text-xs text-slate-500`,
                      children: [
                        `Visiting `,
                        l2.orderedWaypoints.length - 2,
                        ` of`,
                        ` `,
                        a2.length,
                        ` candidate stop`,
  ...
  (0, v.createRoot)(document.getElementById(`root`)).render((0, C.jsx)(_.StrictMode, {
    children: (0, C.jsx)(dn, {})
  }));
})();
